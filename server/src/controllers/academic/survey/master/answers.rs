...
use crate::dtos::academic::survey::master::answers::{
    CreateAnswerRequest, AnswerQuery, AnswerResponse, PaginatedAnswerResponse,
    UpdateAnswerRequest,
};
use crate::dtos::common::reference::MessageResponse;
use crate::models::academic::survey::master::answers as entity_mod;
...
pub async fn list_answers(
    ...
    let query: AnswerQuery = req.parse_queries().unwrap_or_default();
    ...
    let data = items.into_iter().map(|item| AnswerResponse {
            id: item.id,
            code: item.code,
    ...
    Ok(Json(PaginatedAnswerResponse {
        data,
        total,
        page,
        page_size,
...
pub async fn get_answer(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Answer not found"))?;
...
pub async fn create_answer(
    ...
    let payload: CreateAnswerRequest = req.parse_json().await.map_err(|e| {
...
pub async fn update_answer(
    ...
    let payload: UpdateAnswerRequest = req.parse_json().await.map_err(|e| {
        StatusError::bad_request().brief(format!("Invalid JSON payload: {}", e))
    })?;
