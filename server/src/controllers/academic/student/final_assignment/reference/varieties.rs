...
use crate::models::academic::student::final_assignment::reference::varieties as entity_mod;

#[endpoint(tags("Academic - Student - Final_Assignment - Reference - Varieti"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Student - Final_Assignment - Reference - Varieti"), status_codes(200, 400, 404, 500))]
...
#[endpoint(tags("Academic - Student - Final_Assignment - Reference - Varieti"), status_codes(200, 400, 500))]
