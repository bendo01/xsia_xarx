...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_071057_schema_academic_student_campaign_table_detail_activities"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_student_campaign"), Alias::new("detail_activities")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id").uuid().not_null().default(Expr::cust("public.uuid_generate_v7()")),
                    )
                    .col(
                        ColumnDef::new("mark").double().default(Expr::cust("'0'::double precision")),
                    )
                    .col(
                        ColumnDef::new("credit").double(),
                    )
                    .col(
                        ColumnDef::new("grade_id").uuid().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("course_id").uuid().not_null().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("activity_id").uuid().not_null().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("teach_id").uuid().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new("feeder_grade_id").uuid().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("curiculum_detail_sequence").integer().default(0),
                    )
                    .primary_key(
                        Index::create()
                            .name("academic_student_campaign_detail_activities_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
