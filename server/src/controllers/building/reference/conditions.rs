...
use crate::models::building::reference::conditions as entity_mod;

#[endpoint(tags("Building - Reference - Condition"), status_codes(200, 500))]
...
#[endpoint(tags("Building - Reference - Condition"), status_codes(200, 400, 404, 500))]
pub async fn get_condition(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Condition not found"))?;
...
}#[endpoint(tags("Building - Reference - Condition"), status_codes(200, 400, 500))]
...
pub async fn delete_condition(
        ...
        Ok(Json(MessageResponse {
            message: "Condition deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Building - Reference - Condition"), status_codes(200, 500))]
pub async fn options_conditions(
    req: &mut Request,
    depot: &mut Depot,
