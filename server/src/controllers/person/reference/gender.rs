...
use crate::models::person::reference::gender as entity_mod;

#[endpoint(tags("Person - Reference - Gender"), status_codes(200, 500))]
pub async fn list_gender(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Person - Reference - Gender"), status_codes(200, 400, 404, 500))]
pub async fn get_gender(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Gender not found"))?;
...
}#[endpoint(tags("Person - Reference - Gender"), status_codes(200, 400, 500))]
...
pub async fn delete_gender(
        ...
        Ok(Json(MessageResponse {
            message: "Gender deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Person - Reference - Gender"), status_codes(200, 500))]
pub async fn options_gender(
    req: &mut Request,
    depot: &mut Depot,
