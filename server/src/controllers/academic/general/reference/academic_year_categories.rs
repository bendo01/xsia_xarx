...
use crate::models::academic::general::reference::academic_year_categories as entity_mod;

#[endpoint(tags("Academic - General - Reference - AcademicYearCategory"), status_codes(200, 500))]
pub async fn list_academic_year_categories(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Academic - General - Reference - AcademicYearCategory"), status_codes(200, 400, 404, 500))]
pub async fn get_academic_year_categorie(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("AcademicYearCategory not found"))?;
...
}#[endpoint(tags("Academic - General - Reference - AcademicYearCategory"), status_codes(200, 400, 500))]
pub async fn create_academic_year_categorie(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - General - Reference - AcademicYearCategory"), status_codes(200, 400, 404, 500))]
pub async fn update_academic_year_categorie(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - General - Reference - AcademicYearCategory"), status_codes(200, 400, 404, 500))]
pub async fn delete_academic_year_categorie(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "AcademicYearCategory deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Academic - General - Reference - AcademicYearCategory"), status_codes(200, 500))]
pub async fn options_academic_year_categories(
    req: &mut Request,
    depot: &mut Depot,
