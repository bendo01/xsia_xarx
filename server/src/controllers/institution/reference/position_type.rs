...
use crate::models::institution::reference::position_type as entity_mod;

#[endpoint(tags("Institution - Reference - PositionType"), status_codes(200, 500))]
pub async fn list_position_type(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Institution - Reference - PositionType"), status_codes(200, 400, 404, 500))]
pub async fn get_position_type(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("PositionType not found"))?;
...
}#[endpoint(tags("Institution - Reference - PositionType"), status_codes(200, 400, 500))]
pub async fn create_position_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Institution - Reference - PositionType"), status_codes(200, 400, 404, 500))]
pub async fn update_position_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Institution - Reference - PositionType"), status_codes(200, 400, 404, 500))]
pub async fn delete_position_type(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "PositionType deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Institution - Reference - PositionType"), status_codes(200, 500))]
pub async fn options_position_type(
    req: &mut Request,
    depot: &mut Depot,
