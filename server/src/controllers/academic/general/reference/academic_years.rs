...
use crate::dtos::common::reference::{
    CreateReferenceRequest, MessageResponse, OptionItem, OptionRequest, PaginatedReferenceResponse,
...
pub async fn get_academic_year(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("AcademicYear not found"))?;
...
pub async fn create_academic_year(
        ...
        year: Set(Default::default()),
        name: Set(payload.name),
        feeder_name: Set(Default::default()),
        academic_year_category_id: Set(Default::default()),
...
pub async fn delete_academic_year(
        ...
        Ok(Json(MessageResponse {
            message: "AcademicYear deleted successfully".to_string(),
        }))
}
