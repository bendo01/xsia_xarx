...
export default function MasterIndexPage() {
    ...
    const basePath = "/academic/course/master/course-learn-planning";
                ...
                <div class="sm:flex sm:items-center sm:justify-between border-b border-neutral-200 dark:border-neutral-800 pb-4">
                    <div>
                        <nav class="flex items-center gap-1.5 text-xs text-neutral-500 dark:text-neutral-400 mb-1">
                            ...
                            <span>Master</span>
                            <span>/</span>
                            <span class="font-medium text-neutral-900 dark:text-white">Course Learning Planning</span>
                        </nav>
                        <h1 class="text-2xl sm:text-3xl font-bold tracking-tight text-neutral-900 dark:text-white font-mono">
                            Course Learning Plannings Directory
                        </h1>
                        <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-0.5">
                            Manage weekly lesson plans, learning outcomes (CPMK), and pedagogical activities.
                        </p>
                    </div>
                    ...
                    <div class="mt-4 sm:mt-0 flex items-center gap-2">
                        ...
                        >
                            ...
                            <span>Add New Course Learning Planning</span>
                        </a>
                    </div>
                </div>
            ...
            >
                <div class="p-6">
                    <div class="flex items-center gap-3 text-red-600 dark:text-red-400 mb-4">
                        ...
                        <h3 class="text-base font-bold text-neutral-900 dark:text-white">Delete Course Learning Planning Record</h3>
                    </div>
