...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034545_schema_feeder_master_table_mahasiswa"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_master"), Alias::new("mahasiswa")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("nipd").string_len(255),
                    )
                    .col(
                        ColumnDef::new("ipk").float(),
                    )
                    .col(
                        ColumnDef::new("total_sks").float(),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new("id_status_mahasiswa").integer(),
                    )
                    .col(
                        ColumnDef::new("nama_status_mahasiswa").string_len(255),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_master_mahasiswa_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
