...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_145507_schema_contact_master_table_phones"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("contact_master"), Alias::new("phones")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id").uuid().not_null().default(Expr::cust("public.uuid_generate_v7()")),
                    )
                    .col(
                        ColumnDef::new("phone_number").string_len(255).not_null(),
                    )
                    .col(
                        ColumnDef::new("phone_type_id").uuid().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("phoneable_id").uuid().not_null().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("phoneable_type").string_len(255).not_null(),
                    )
                    .col(
