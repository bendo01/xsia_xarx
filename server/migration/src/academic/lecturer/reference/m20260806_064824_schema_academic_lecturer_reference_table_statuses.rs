...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_064824_schema_academic_lecturer_reference_table_statuses"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_lecturer_reference"), Alias::new("statuses")))
                    .if_not_exists()
                    .col(
