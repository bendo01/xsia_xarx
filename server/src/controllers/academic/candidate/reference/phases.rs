...
use crate::models::academic::candidate::reference::phases as entity_mod;

#[endpoint(tags("Academic - Candidate - Reference - Phas"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Candidate - Reference - Phas"), status_codes(200, 400, 404, 500))]
pub async fn get_phase(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Phas not found"))?;
...
}#[endpoint(tags("Academic - Candidate - Reference - Phas"), status_codes(200, 400, 500))]
...
pub async fn delete_phase(
        ...
        Ok(Json(MessageResponse {
            message: "Phas deleted successfully".to_string(),
        }))
}
