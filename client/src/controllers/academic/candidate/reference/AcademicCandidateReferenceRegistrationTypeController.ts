...
const path = 'academic/candidate/reference/registration-types';
...
export async function AcademicCandidateReferenceControllerRegistrationTypeIndex(
    ...
    try {
        ...
        console.error('Error in AcademicCandidateReferenceControllerRegistrationTypeIndex:', e);
        return {
            pagination: {
                search: props.search || '',
                sort_by: props.sort_by || '',
...
export async function getRegistrationTypeLists(): Promise<{
    code: number;
