...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_103354_schema_academic_student_reference_table_selection_types"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_student_reference"), Alias::new("selection_types")))
                    .if_not_exists()
                    .col(
