...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        db.execute_unprepared(
            "
            CREATE TABLE IF NOT EXISTS literate.educations
            (
                ...
                level_id uuid NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000'::uuid,
                ...
                CONSTRAINT literate_educations_pkey PRIMARY KEY (id)
            )
            ",
        )
        .await?;
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .get_connection()
            .execute_unprepared("DROP TABLE IF EXISTS literate.educations")
            .await?;
