...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_131448_schema_document_reference_table_archive_types"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .get_connection()
            .execute_unprepared("CREATE SCHEMA IF NOT EXISTS document_reference")
            .await?;

        manager
            .create_table(
                Table::create()
                    .table((Alias::new("document_reference"), Alias::new("archive_types")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("document_reference_archive_types_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
