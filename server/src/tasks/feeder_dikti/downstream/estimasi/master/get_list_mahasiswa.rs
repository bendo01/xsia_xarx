...
use crate::jobs::feeder_dikti::downstream::master::upsert::get_list_mahasiswa::{
    ModelInput, Worker as JobWorker, WorkerArgs,
};

// Configuration constants
const TASK_NAME: &str = "EstimateListMahasiswa";
const API_ACTION: &str = "GetListMahasiswa";

// API Request Configuration
const DEFAULT_LIMIT: i32 = 1000;
const DEFAULT_ORDER: &str = "nipd ASC";
const DEFAULT_FILTER: &str = "";


pub struct EstimateListMahasiswa;

impl EstimateListMahasiswa {
...
#[async_trait]
impl Task for EstimateListMahasiswa {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetListMahasiswa data from Feeder Dikti"
    }
