...
use crate::models::academic::survey::reference::bundle_categories as entity_mod;

#[endpoint(tags("Academic - Survey - Reference - BundleCategory"), status_codes(200, 500))]
pub async fn list_bundle_categories(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Academic - Survey - Reference - BundleCategory"), status_codes(200, 400, 404, 500))]
pub async fn get_bundle_categorie(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("BundleCategory not found"))?;
...
}#[endpoint(tags("Academic - Survey - Reference - BundleCategory"), status_codes(200, 400, 500))]
pub async fn create_bundle_categorie(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - Survey - Reference - BundleCategory"), status_codes(200, 400, 404, 500))]
pub async fn update_bundle_categorie(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - Survey - Reference - BundleCategory"), status_codes(200, 400, 404, 500))]
pub async fn delete_bundle_categorie(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "BundleCategory deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Academic - Survey - Reference - BundleCategory"), status_codes(200, 500))]
pub async fn options_bundle_categories(
    req: &mut Request,
    depot: &mut Depot,
