...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034546_schema_feeder_master_table_periode_aktif"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_master"), Alias::new("periode_aktif")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("kode_prodi").string_len(255),
                    )
                    .col(
                        ColumnDef::new("nama_program_studi").string_len(255),
                    )
                    .col(
                        ColumnDef::new("status_prodi").string_len(255),
                    )
                    .col(
                        ColumnDef::new("jenjang_pendidikan").string_len(255),
                    )
                    .col(
                        ColumnDef::new("periode_pelaporan").string_len(255),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_master_periode_aktif_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
