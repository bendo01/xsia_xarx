...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_071454_schema_academic_student_final_assignment_transaction_table_evaluation_summaries"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_student_final_assignment_transaction"), Alias::new("evaluation_summaries")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("academic_student_final_assignment_transaction_evaluation_summar")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
