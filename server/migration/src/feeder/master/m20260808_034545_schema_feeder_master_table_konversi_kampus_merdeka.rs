...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034545_schema_feeder_master_table_konversi_kampus_merdeka"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_master"), Alias::new("konversi_kampus_merdeka")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("id_konversi_aktivitas").uuid(),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_master_konversi_kampus_merdeka_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
