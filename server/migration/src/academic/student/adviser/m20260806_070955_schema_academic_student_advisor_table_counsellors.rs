...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_070955_schema_academic_student_advisor_table_counsellors"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_student_adviser"), Alias::new("counsellors")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id").uuid().not_null().default(Expr::cust("public.uuid_generate_v7()")),
                    )
                    .col(
                        ColumnDef::new("decree_id").uuid().not_null().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("academic_student_adviser_counsellors_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
