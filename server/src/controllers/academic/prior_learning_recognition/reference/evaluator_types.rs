...
use crate::models::academic::prior_learning_recognition::reference::evaluator_types as entity_mod;

#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvaluatorTyp"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvaluatorTyp"), status_codes(200, 400, 404, 500))]
pub async fn get_evaluator_type(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("EvaluatorTyp not found"))?;
...
}#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvaluatorTyp"), status_codes(200, 400, 500))]
...
pub async fn delete_evaluator_type(
        ...
        Ok(Json(MessageResponse {
            message: "EvaluatorTyp deleted successfully".to_string(),
        }))
}
