...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034546_schema_feeder_master_table_riwayat_sertifikasi_dosen"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_master"), Alias::new("riwayat_sertifikasi_dosen")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("nomor_peserta").string_len(255),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new("id_jenis_sertifikasi").string_len(255),
                    )
                    .col(
                        ColumnDef::new("nama_jenis_sertifikasi").string_len(255),
                    )
                    .col(
                        ColumnDef::new("tahun_sertifikasi").string_len(255),
                    )
                    .col(
                        ColumnDef::new("sk_sertifikasi").string_len(255),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_master_riwayat_sertifikasi_dosen_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
