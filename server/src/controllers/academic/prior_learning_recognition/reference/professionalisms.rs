...
use crate::models::academic::prior_learning_recognition::reference::professionalisms as entity_mod;

#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - Professionalism"), status_codes(200, 500))]
pub async fn list_professionalisms(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - Professionalism"), status_codes(200, 400, 404, 500))]
pub async fn get_professionalism(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Professionalism not found"))?;
...
}#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - Professionalism"), status_codes(200, 400, 500))]
pub async fn create_professionalism(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - Professionalism"), status_codes(200, 400, 404, 500))]
pub async fn update_professionalism(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - Professionalism"), status_codes(200, 400, 404, 500))]
pub async fn delete_professionalism(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "Professionalism deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - Professionalism"), status_codes(200, 500))]
pub async fn options_professionalisms(
    req: &mut Request,
    depot: &mut Depot,
