...
#[endpoint(tags("Academic - Survey - Reference - BundleCategori"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Survey - Reference - BundleCategori"), status_codes(200, 400, 404, 500))]
pub async fn get_bundle_categorie(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("BundleCategori not found"))?;
...
}#[endpoint(tags("Academic - Survey - Reference - BundleCategori"), status_codes(200, 400, 500))]
...
pub async fn delete_bundle_categorie(
        ...
        Ok(Json(MessageResponse {
            message: "BundleCategori deleted successfully".to_string(),
        }))
}
