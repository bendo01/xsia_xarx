...
export default function AcademicStudentFinalassignmentTransactionEvaluationdetailsPage() {
    return (
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            ...
                            <p class="text-xs text-neutral-500 dark:text-neutral-400 mt-1 font-mono">
                                Route: <span class="text-blue-600 dark:text-blue-400">/academic/student/final_assignment/transaction/evaluation_details</span>
                            </p>
                        </div>
                    </div>
                </div>
