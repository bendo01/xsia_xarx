...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034546_schema_feeder_master_table_rencana_pembelajaran"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_master"), Alias::new("rencana_pembelajaran")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id").uuid().not_null().default(Expr::cust("public.uuid_generate_v7()")),
                    )
                    .col(
                        ColumnDef::new("id_rencana_ajar").uuid(),
                    )
                    .col(
                        ColumnDef::new("id_matkul").uuid(),
                    )
                    .col(
                        ColumnDef::new("nama_mata_kuliah").string(),
                    )
                    .col(
                        ColumnDef::new("kode_mata_kuliah").string(),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new("nama_program_studi").string(),
                    )
                    .col(
                        ColumnDef::new("pertemuan").integer(),
                    )
                    .col(
                        ColumnDef::new("materi_indonesia").text(),
                    )
                    .col(
                        ColumnDef::new("materi_inggris").text(),
                    )
                    .col(
                        ColumnDef::new("status_sync").string(),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_master_rencana_pembelajaran_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
