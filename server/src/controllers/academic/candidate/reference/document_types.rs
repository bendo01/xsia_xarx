...
#[endpoint(tags("Academic - Candidate - Reference - DocumentTyp"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Candidate - Reference - DocumentTyp"), status_codes(200, 400, 404, 500))]
pub async fn get_document_type(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("DocumentTyp not found"))?;
...
}#[endpoint(tags("Academic - Candidate - Reference - DocumentTyp"), status_codes(200, 400, 500))]
...
pub async fn delete_document_type(
        ...
        Ok(Json(MessageResponse {
            message: "DocumentTyp deleted successfully".to_string(),
        }))
}
