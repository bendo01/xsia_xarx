...
use crate::models::academic::candidate::reference::registration_categories as entity_mod;

#[endpoint(tags("Academic - Candidate - Reference - RegistrationCategory"), status_codes(200, 500))]
pub async fn list_registration_categories(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let data = items.into_iter().map(|item| ReferenceResponse {
            ...
            alphabet_code: item.alphabet_code.clone().unwrap_or_default(),
...
#[endpoint(tags("Academic - Candidate - Reference - RegistrationCategory"), status_codes(200, 400, 404, 500))]
pub async fn get_registration_categorie(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("RegistrationCategory not found"))?;
...
}#[endpoint(tags("Academic - Candidate - Reference - RegistrationCategory"), status_codes(200, 400, 500))]
pub async fn create_registration_categorie(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
        ...
        alphabet_code: Set(Some(payload.alphabet_code)),
...
#[endpoint(tags("Academic - Candidate - Reference - RegistrationCategory"), status_codes(200, 400, 404, 500))]
pub async fn update_registration_categorie(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - Candidate - Reference - RegistrationCategory"), status_codes(200, 400, 404, 500))]
pub async fn delete_registration_categorie(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "RegistrationCategory deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Academic - Candidate - Reference - RegistrationCategory"), status_codes(200, 500))]
pub async fn options_registration_categories(
    req: &mut Request,
    depot: &mut Depot,
