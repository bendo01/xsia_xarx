...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_063804_schema_academic_course_master_table_concentrations"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_course_master"), Alias::new("concentrations")))
                    .if_not_exists()
                    .col(
