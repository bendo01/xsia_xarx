...
#[endpoint(tags("Person - Reference - MaritalStatu"), status_codes(200, 500))]
...
#[endpoint(tags("Person - Reference - MaritalStatu"), status_codes(200, 400, 404, 500))]
pub async fn get_marital_statu(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("MaritalStatu not found"))?;
...
}#[endpoint(tags("Person - Reference - MaritalStatu"), status_codes(200, 400, 500))]
...
pub async fn delete_marital_statu(
        ...
        Ok(Json(MessageResponse {
            message: "MaritalStatu deleted successfully".to_string(),
        }))
}
