...
use crate::jobs::feeder_dikti::downstream::master::upsert::get_list_nilai_transfer_pendidikan_mahasiswa::{
    ModelInput, Worker as JobWorker, WorkerArgs,
};

// Configuration constants
const TASK_NAME: &str = "EstimateListNilaiTransferPendidikanMahasiswa";
const API_ACTION: &str = "GetNilaiTransferPendidikanMahasiswa";

// API Request Configuration
const DEFAULT_LIMIT: i32 = 1000;
const DEFAULT_ORDER: &str = "id_transfer ASC";
const DEFAULT_FILTER: &str = "";


pub struct EstimateListNilaiTransferPendidikanMahasiswa;

impl EstimateListNilaiTransferPendidikanMahasiswa {
...
#[async_trait]
impl Task for EstimateListNilaiTransferPendidikanMahasiswa {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetNilaiTransferPendidikanMahasiswa data from Feeder Dikti"
    }
