...
#[endpoint(tags("Academic - Candidate - Reference - RegistrationCategori"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Candidate - Reference - RegistrationCategori"), status_codes(200, 400, 404, 500))]
pub async fn get_registration_categorie(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("RegistrationCategori not found"))?;
...
#[endpoint(tags("Academic - Candidate - Reference - RegistrationCategori"), status_codes(200, 400, 500))]
...
pub async fn delete_registration_categorie(
    ...
    Ok(Json(MessageResponse {
        message: "RegistrationCategori deleted successfully".to_string(),
    }))
}
