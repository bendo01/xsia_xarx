...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_070611_schema_academic_prior_learning_recognition_reference_table_professionalisms"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_prior_learning_recognition_reference"), Alias::new("professionalisms")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("academic_prior_learning_recognition_reference_professionalisms_")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
