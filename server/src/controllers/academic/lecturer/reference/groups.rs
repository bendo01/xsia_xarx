...
use crate::models::academic::lecturer::reference::groups as entity_mod;

#[endpoint(tags("Academic - Lecturer - Reference - Group"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Lecturer - Reference - Group"), status_codes(200, 400, 404, 500))]
...
}#[endpoint(tags("Academic - Lecturer - Reference - Group"), status_codes(200, 400, 500))]
