...
#[endpoint(tags("Contact - Reference - ResidenceTyp"), status_codes(200, 500))]
...
#[endpoint(tags("Contact - Reference - ResidenceTyp"), status_codes(200, 400, 404, 500))]
pub async fn get_residence_type(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("ResidenceTyp not found"))?;
...
#[endpoint(tags("Contact - Reference - ResidenceTyp"), status_codes(200, 400, 500))]
...
pub async fn delete_residence_type(
    ...
    Ok(Json(MessageResponse {
        message: "ResidenceTyp deleted successfully".to_string(),
    }))
}
