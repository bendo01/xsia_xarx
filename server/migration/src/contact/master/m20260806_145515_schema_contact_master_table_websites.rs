...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_145515_schema_contact_master_table_websites"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("contact_master"), Alias::new("websites")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id").uuid().not_null().default(Expr::cust("public.uuid_generate_v7()")),
                    )
                    .col(
                        ColumnDef::new("website_url").string_len(255).not_null(),
                    )
                    .col(
                        ColumnDef::new("website_type_id").uuid().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("websiteable_id").uuid().not_null().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("websiteable_type").string_len(255).not_null(),
                    )
                    .col(
