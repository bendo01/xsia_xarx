...
): Promise<TypePaginationResponse<AcademicPriorLearningRecognitionReferenceEvaluatorType>> {
    try {
        ...
        console.error('Error in AcademicPriorLearningRecognitionReferenceControllerEvaluatorTypeIndex:', e);
        return {
            pagination: {
                search: props.search || '',
                sort_by: props.sort_by || '',
...
export async function AcademicPriorLearningRecognitionReferenceControllerEvaluatorTypeUpsert(
...
export async function AcademicPriorLearningRecognitionReferenceControllerEvaluatorTypeDelete(
    props: { id: string },
