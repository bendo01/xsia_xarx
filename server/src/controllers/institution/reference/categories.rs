...
use crate::models::institution::reference::categories as entity_mod;

#[endpoint(tags("Institution Reference - Categori"), status_codes(200, 500))]
...
#[endpoint(tags("Institution Reference - Categori"), status_codes(200, 400, 404, 500))]
pub async fn get_categories(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .map_err(|e| StatusError::internal_server_error().brief(e.to_string()))?
        .ok_or_else(|| {
            StatusError::not_found().brief(format!("Categori not found"))
        })?;
...
#[endpoint(tags("Institution Reference - Categori"), status_codes(200, 400, 500))]
...
pub async fn delete_categories(
    ...
    Ok(Json(MessageResponse {
        message: format!("Categori deleted successfully"),
    }))
}
