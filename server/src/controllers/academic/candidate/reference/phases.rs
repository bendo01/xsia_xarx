...
#[endpoint(tags("Academic - Candidate - Reference - Phase"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Candidate - Reference - Phase"), status_codes(200, 400, 404, 500))]
pub async fn get_phase(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Phase not found"))?;
...
}#[endpoint(tags("Academic - Candidate - Reference - Phase"), status_codes(200, 400, 500))]
