...
#[endpoint(tags("Academic - Student - Final_Assignment - Reference - Stage"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Student - Final_Assignment - Reference - Stage"), status_codes(200, 400, 404, 500))]
pub async fn get_stage(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Stage not found"))?;
...
}#[endpoint(tags("Academic - Student - Final_Assignment - Reference - Stage"), status_codes(200, 400, 500))]
