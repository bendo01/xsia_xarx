...
#[endpoint(tags("Contact - Reference - WebsiteTyp"), status_codes(200, 500))]
...
#[endpoint(tags("Contact - Reference - WebsiteTyp"), status_codes(200, 400, 404, 500))]
pub async fn get_website_type(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("WebsiteTyp not found"))?;
...
}#[endpoint(tags("Contact - Reference - WebsiteTyp"), status_codes(200, 400, 500))]
...
pub async fn delete_website_type(
        ...
        Ok(Json(MessageResponse {
            message: "WebsiteTyp deleted successfully".to_string(),
        }))
}
