...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034545_schema_feeder_master_table_detail_nilai_perkuliahan_kelas"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_master"), Alias::new("detail_nilai_perkuliahan_kelas")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("jurusan").string_len(255),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_master_detail_nilai_perkuliahan_kelas_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
