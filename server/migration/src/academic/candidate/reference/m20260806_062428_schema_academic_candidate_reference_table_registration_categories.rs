...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_062428_schema_academic_candidate_reference_table_registration_categories"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_candidate_reference"), Alias::new("registration_categories")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("acr_registration_categories_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
