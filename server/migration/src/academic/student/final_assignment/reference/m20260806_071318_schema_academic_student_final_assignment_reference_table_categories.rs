...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_071318_schema_academic_student_final_assignment_reference_table_categories"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_student_final_assignment_reference"), Alias::new("categories")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("academic_student_final_assignment_reference_categories_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
