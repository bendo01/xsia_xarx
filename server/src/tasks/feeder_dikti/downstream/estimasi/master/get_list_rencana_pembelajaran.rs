...
use crate::jobs::feeder_dikti::downstream::master::upsert::get_list_rencana_pembelajaran::{
    ModelInput, Worker as JobWorker, WorkerArgs,
};

// Configuration constants
const TASK_NAME: &str = "EstimateListRencanaPembelajaran";
const API_ACTION: &str = "GetListRencanaPembelajaran";
...
pub struct EstimateListRencanaPembelajaran;

impl EstimateListRencanaPembelajaran {
...
#[async_trait]
impl Task for EstimateListRencanaPembelajaran {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetListRencanaPembelajaran data from Feeder Dikti"
    }
