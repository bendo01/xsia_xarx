...
#[endpoint(tags("Academic - Campaign - Reference - Substanc"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Campaign - Reference - Substanc"), status_codes(200, 400, 404, 500))]
pub async fn get_substance(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Substanc not found"))?;
...
#[endpoint(tags("Academic - Campaign - Reference - Substanc"), status_codes(200, 400, 500))]
...
pub async fn delete_substance(
    ...
    Ok(Json(MessageResponse {
        message: "Substanc deleted successfully".to_string(),
    }))
}
