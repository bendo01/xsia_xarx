...
use crate::models::person::reference::hair_color as entity_mod;

#[endpoint(tags("Person - Reference - HairColor"), status_codes(200, 500))]
pub async fn list_hair_color(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Person - Reference - HairColor"), status_codes(200, 400, 404, 500))]
pub async fn get_hair_color(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("HairColor not found"))?;
...
}#[endpoint(tags("Person - Reference - HairColor"), status_codes(200, 400, 500))]
pub async fn create_hair_color(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Person - Reference - HairColor"), status_codes(200, 400, 404, 500))]
pub async fn update_hair_color(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Person - Reference - HairColor"), status_codes(200, 400, 404, 500))]
pub async fn delete_hair_color(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "HairColor deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Person - Reference - HairColor"), status_codes(200, 500))]
pub async fn options_hair_color(
    req: &mut Request,
    depot: &mut Depot,
