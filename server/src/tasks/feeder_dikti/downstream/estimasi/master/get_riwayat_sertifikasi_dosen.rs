...
use crate::jobs::feeder_dikti::downstream::master::upsert::get_riwayat_sertifikasi_dosen::{
    RiwayatSertifikasiDosen, Worker as JobWorker, WorkerArgs,
};

// Configuration constants
const TASK_NAME: &str = "EstimateRiwayatSertifikasiDosen";
const API_ACTION: &str = "GetRiwayatSertifikasiDosen";
...
pub struct EstimateRiwayatSertifikasiDosen;

impl EstimateRiwayatSertifikasiDosen {
    ...
    async fn fetch_and_process_page(
        ...
        let response = RequestData::get::<RiwayatSertifikasiDosen>(
            InputRequestData {
...
#[async_trait]
impl Task for EstimateRiwayatSertifikasiDosen {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetRiwayatSertifikasiDosen data from Feeder Dikti"
    }
