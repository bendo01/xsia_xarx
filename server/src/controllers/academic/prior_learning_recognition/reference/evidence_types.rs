...
use crate::models::academic::prior_learning_recognition::reference::evidence_types as entity_mod;

#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvidenceType"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvidenceType"), status_codes(200, 400, 404, 500))]
pub async fn get_evidence_type(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("EvidenceType not found"))?;
...
}#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvidenceType"), status_codes(200, 400, 500))]
pub async fn create_evidence_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvidenceType"), status_codes(200, 400, 404, 500))]
pub async fn update_evidence_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvidenceType"), status_codes(200, 400, 404, 500))]
pub async fn delete_evidence_type(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "EvidenceType deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvidenceType"), status_codes(200, 500))]
pub async fn options_evidence_types(
    req: &mut Request,
    depot: &mut Depot,
