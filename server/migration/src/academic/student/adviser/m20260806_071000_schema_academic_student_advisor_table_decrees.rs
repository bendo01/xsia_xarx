...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_071000_schema_academic_student_advisor_table_decrees"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .get_connection()
            .execute_unprepared("CREATE SCHEMA IF NOT EXISTS academic_student_adviser")
            .await?;

        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_student_adviser"), Alias::new("decrees")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("academic_student_adviser_decrees_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
