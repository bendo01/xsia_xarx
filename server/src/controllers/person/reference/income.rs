...
use crate::models::person::reference::income as entity_mod;

#[endpoint(tags("Person Reference - Income"), status_codes(200, 500))]
...
#[endpoint(tags("Person Reference - Income"), status_codes(200, 400, 404, 500))]
pub async fn get_income(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .map_err(|e| StatusError::internal_server_error().brief(e.to_string()))?
        .ok_or_else(|| {
            StatusError::not_found().brief(format!("Income not found"))
        })?;
...
#[endpoint(tags("Person Reference - Income"), status_codes(200, 400, 500))]
...
pub async fn delete_income(
    ...
    Ok(Json(MessageResponse {
        message: format!("Income deleted successfully"),
    }))
}
