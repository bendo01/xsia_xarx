...
pub struct Model {
    ...
    pub id_jns_daftar: NullableString,
    ...
    pub jalur_masuk: BelongsTo<crate::models::feeder::referensi::jalur_masuk::Entity>,
    #[serde(skip)]
