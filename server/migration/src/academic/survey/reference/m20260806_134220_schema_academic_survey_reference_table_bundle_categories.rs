...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_134220_schema_academic_survey_reference_table_bundle_categories"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_survey_reference"), Alias::new("bundle_categories")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("asvr_bundle_categories_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
