...
const API_ACTION: &str = "GetJenisPendaftaran";
...
impl EstimateGetJenisPendaftaran {
    ...
    async fn fetch_and_process_page(
        ...
        let response = RequestData::get::<GetJenisPendaftaranResponse>(
            InputRequestData {
...
#[async_trait]
impl Task for EstimateGetJenisPendaftaran {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetJenisPendaftaran data from Feeder Dikti"
    }
