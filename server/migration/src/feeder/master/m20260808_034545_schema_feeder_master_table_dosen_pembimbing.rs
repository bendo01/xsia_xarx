...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034545_schema_feeder_master_table_dosen_pembimbing"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_master"), Alias::new("dosen_pembimbing")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("jenis_aktivitas").string_len(255),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_master_dosen_pembimbing_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
