...
use crate::jobs::feeder_dikti::downstream::master::upsert::get_detail_perkuliahan_mahasiswa::{
    ModelInputDetailPerkuliahanMahasiswa, Worker as JobWorker, WorkerArgs,
};
