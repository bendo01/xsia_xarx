...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034547_schema_feeder_referensi_table_tahun_ajaran"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_referensi"), Alias::new("tahun_ajaran")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("a_periode_aktif").string_len(255),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_referensi_tahun_ajaran_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
