...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_134107_schema_academic_survey_master_table_bundle_question"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_survey_master"), Alias::new("bundle_question")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("asvm_bundle_question_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
