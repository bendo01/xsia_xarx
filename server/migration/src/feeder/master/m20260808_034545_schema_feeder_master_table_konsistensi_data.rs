...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034545_schema_feeder_master_table_konsistensi_data"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_master"), Alias::new("konsistensi_data")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("total").integer().not_null(),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_master_konsistensi_data_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
