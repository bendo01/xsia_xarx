...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_064610_schema_academic_general_reference_table_academic_year_categories"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_general_reference"), Alias::new("academic_year_categories")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("agr_academic_year_categories_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
