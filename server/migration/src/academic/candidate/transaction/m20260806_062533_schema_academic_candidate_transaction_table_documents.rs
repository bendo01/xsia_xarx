...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_062533_schema_academic_candidate_transaction_table_documents"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_candidate_transaction"), Alias::new("documents")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("document_type_id").uuid().not_null().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new("size").integer(),
                    )
                    .col(
                        ColumnDef::new("is_verified").boolean().default(Expr::cust("false")),
                    )
                    .col(
