...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260805_071526_schema_institution_master_table_units"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("institution_master"), Alias::new("units")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id")
                            .uuid()
