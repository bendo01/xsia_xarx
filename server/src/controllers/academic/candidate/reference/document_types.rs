...
use crate::models::academic::candidate::reference::document_types as entity_mod;

#[endpoint(tags("Academic - Candidate - Reference - DocumentType"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Candidate - Reference - DocumentType"), status_codes(200, 400, 404, 500))]
pub async fn get_document_type(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("DocumentType not found"))?;
...
}#[endpoint(tags("Academic - Candidate - Reference - DocumentType"), status_codes(200, 400, 500))]
...
pub async fn delete_document_type(
        ...
        Ok(Json(MessageResponse {
            message: "DocumentType deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Academic - Candidate - Reference - DocumentType"), status_codes(200, 500))]
pub async fn options_document_types(
    req: &mut Request,
    depot: &mut Depot,
