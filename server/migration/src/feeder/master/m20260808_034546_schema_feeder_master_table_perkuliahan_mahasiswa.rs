...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034546_schema_feeder_master_table_perkuliahan_mahasiswa"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_master"), Alias::new("perkuliahan_mahasiswa")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("id_status_mahasiswa").string_len(255),
                    )
                    .col(
                        ColumnDef::new("nama_status_mahasiswa").string_len(255),
                    )
                    .col(
                        ColumnDef::new("ips").float().default(0),
                    )
                    .col(
                        ColumnDef::new("ipk").float().default(0),
                    )
                    .col(
                        ColumnDef::new("sks_semester").float().default(0),
                    )
                    .col(
                        ColumnDef::new("sks_total").float().default(0),
                    )
                    .col(
                        ColumnDef::new("biaya_kuliah_smt").float().default(0),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_master_perkuliahan_mahasiswa_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
