...
#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvidenceTyp"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvidenceTyp"), status_codes(200, 400, 404, 500))]
pub async fn get_evidence_type(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("EvidenceTyp not found"))?;
...
#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvidenceTyp"), status_codes(200, 400, 500))]
...
pub async fn delete_evidence_type(
    ...
    Ok(Json(MessageResponse {
        message: "EvidenceTyp deleted successfully".to_string(),
    }))
}
