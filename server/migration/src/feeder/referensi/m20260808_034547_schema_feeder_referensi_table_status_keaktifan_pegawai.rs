...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034547_schema_feeder_referensi_table_status_keaktifan_pegawai"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_referensi"), Alias::new("status_keaktifan_pegawai")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_referensi_status_keaktifan_pegawai_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
