...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_134100_schema_academic_survey_master_table_answers"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_survey_master"), Alias::new("answers")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("point").double().not_null().default(Expr::cust("'0'::double precision")),
                    )
                    .col(
