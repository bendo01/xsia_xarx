...
const TASK_NAME: &str = "EstimateGetAllPT";
const API_ACTION: &str = "GetAllPT";
...
pub struct EstimateGetAllPT;

impl EstimateGetAllPT {
    ...
    async fn fetch_and_process_page(
        ...
        let response = RequestData::get::<GetAllPTResponse>(
            InputRequestData {
...
#[async_trait]
impl Task for EstimateGetAllPT {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetAllPT data from Feeder Dikti"
    }
