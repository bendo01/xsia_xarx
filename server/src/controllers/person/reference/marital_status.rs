...
use crate::models::person::reference::marital_status as entity_mod;

#[endpoint(tags("Person - Reference - MaritalStatus"), status_codes(200, 500))]
pub async fn list_marital_status(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Person - Reference - MaritalStatus"), status_codes(200, 400, 404, 500))]
pub async fn get_marital_statu(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("MaritalStatus not found"))?;
...
}#[endpoint(tags("Person - Reference - MaritalStatus"), status_codes(200, 400, 500))]
pub async fn create_marital_statu(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Person - Reference - MaritalStatus"), status_codes(200, 400, 404, 500))]
pub async fn update_marital_statu(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Person - Reference - MaritalStatus"), status_codes(200, 400, 404, 500))]
pub async fn delete_marital_statu(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "MaritalStatus deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Person - Reference - MaritalStatus"), status_codes(200, 500))]
pub async fn options_marital_status(
    req: &mut Request,
    depot: &mut Depot,
