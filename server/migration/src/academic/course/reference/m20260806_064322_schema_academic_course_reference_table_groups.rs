...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_064322_schema_academic_course_reference_table_groups"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_course_reference"), Alias::new("groups")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("abbreviation").string_len(255),
                    )
                    .col(
