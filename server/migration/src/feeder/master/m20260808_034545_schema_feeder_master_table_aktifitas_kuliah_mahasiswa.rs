...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034545_schema_feeder_master_table_aktifitas_kuliah_mahasiswa"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_master"), Alias::new("aktifitas_kuliah_mahasiswa")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("ips").float(),
                    )
                    .col(
                        ColumnDef::new("ipk").float(),
                    )
                    .col(
                        ColumnDef::new("sks_semester").float(),
                    )
                    .col(
                        ColumnDef::new("sks_total").float(),
                    )
                    .col(
                        ColumnDef::new("biaya_kuliah_smt").float(),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_master_aktifitas_kuliah_mahasiswa_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
