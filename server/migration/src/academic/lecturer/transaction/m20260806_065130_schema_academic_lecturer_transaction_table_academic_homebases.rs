...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_065130_schema_academic_lecturer_transaction_table_academic_homebases"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_lecturer_transaction"), Alias::new("homebases")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("contract_id").uuid().not_null().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
