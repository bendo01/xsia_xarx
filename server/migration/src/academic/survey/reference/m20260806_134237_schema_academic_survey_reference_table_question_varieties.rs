...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_134237_schema_academic_survey_reference_table_question_varieties"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .get_connection()
            .execute_unprepared("CREATE SCHEMA IF NOT EXISTS academic_survey_reference")
            .await?;

        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_survey_reference"), Alias::new("question_varieties")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("asvr_question_varieties_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
