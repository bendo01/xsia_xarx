...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        db.execute_unprepared(
            "
            CREATE TABLE IF NOT EXISTS building_master.buildings
            (
                ...
                residence_id uuid NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000'::uuid,
                ...
                CONSTRAINT bm_buildings_pkey PRIMARY KEY (id)
            )
            ",
        )
        .await?;
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .get_connection()
            .execute_unprepared("DROP TABLE IF EXISTS building_master.buildings")
            .await?;
