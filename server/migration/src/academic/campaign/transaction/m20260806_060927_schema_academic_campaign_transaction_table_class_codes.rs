...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_060927_schema_academic_campaign_transaction_table_class_codes"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_campaign_transaction"), Alias::new("class_codes")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("capacity").integer().default(0),
                    )
                    .primary_key(
                        Index::create()
                            .name("act_class_codes_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
