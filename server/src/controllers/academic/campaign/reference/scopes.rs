...
use crate::models::academic::campaign::reference::scopes as entity_mod;

#[endpoint(tags("Academic - Campaign - Reference - Scop"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Campaign - Reference - Scop"), status_codes(200, 400, 404, 500))]
pub async fn get_scope(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Scop not found"))?;
...
#[endpoint(tags("Academic - Campaign - Reference - Scop"), status_codes(200, 400, 500))]
...
pub async fn delete_scope(
    ...
    Ok(Json(MessageResponse {
        message: "Scop deleted successfully".to_string(),
    }))
}
