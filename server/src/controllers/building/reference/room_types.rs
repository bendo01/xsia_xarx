...
#[endpoint(tags("Building - Reference - RoomTyp"), status_codes(200, 500))]
...
#[endpoint(tags("Building - Reference - RoomTyp"), status_codes(200, 400, 404, 500))]
pub async fn get_room_type(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("RoomTyp not found"))?;
...
}#[endpoint(tags("Building - Reference - RoomTyp"), status_codes(200, 400, 500))]
...
pub async fn delete_room_type(
        ...
        Ok(Json(MessageResponse {
            message: "RoomTyp deleted successfully".to_string(),
        }))
}
