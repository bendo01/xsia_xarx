...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034547_schema_feeder_referensi_table_status_kepegawaian"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_referensi"), Alias::new("status_kepegawaian")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id").uuid().not_null().default(Expr::cust("public.uuid_generate_v7()")),
                    )
                    .col(
                        ColumnDef::new("nama_status_pegawai").string_len(255),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new("id_status_pegawai").integer(),
                    )
                    .primary_key(
                        Index::create()
                            .name("feeder_referensi_status_kepegawaian_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
