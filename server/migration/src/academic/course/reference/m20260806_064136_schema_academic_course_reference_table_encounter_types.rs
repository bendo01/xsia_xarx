...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_064136_schema_academic_course_reference_table_encounter_types"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_course_reference"), Alias::new("encounter_types")))
                    .if_not_exists()
                    .col(
