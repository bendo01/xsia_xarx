...
export async function PersonReferenceControllerGenderDelete(data: TypeInputEntityReferenceForm): Promise<UpsertDeleteMessage> {
    let returned = {
        is_error: false,
        code: 200,
        message: "success to upsert reference.",
...
export async function PersonReferenceControllerGenderList(): Promise<{
    ...
    try {
        const response = await fetch(`${server_api_url}person/reference/genders/list`, {
            method: "GET",
            headers: {
