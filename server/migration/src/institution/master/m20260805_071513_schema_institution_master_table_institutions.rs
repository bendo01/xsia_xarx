...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260805_071513_schema_institution_master_table_institutions"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("institution_master"), Alias::new("institutions")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id")
                            .uuid()
                    ...
                    .col(
                        ColumnDef::new("feeder_id")
                            .uuid()
                            .default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("academic_year_id")
                            .uuid()
                            .default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
