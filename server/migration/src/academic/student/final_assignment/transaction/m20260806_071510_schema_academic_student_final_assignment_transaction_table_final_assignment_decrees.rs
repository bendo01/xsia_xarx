...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_071510_schema_academic_student_final_assignment_transaction_table_final_assignment_decrees"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_student_final_assignment_transaction"), Alias::new("final_assignment_decrees")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id").uuid().not_null().default(Expr::cust("public.uuid_generate_v7()")),
                    )
                    .col(
                        ColumnDef::new("decree_number").string_len(255).not_null(),
                    )
                    .col(
                        ColumnDef::new("decree_date").date().not_null(),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new("staff_id").uuid().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("academic_student_final_assignment_transaction_final_assignment_")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
