...
pub struct Model {
    ...
    #[serde(skip)]
    #[sea_orm(belongs_to, from = "id_jenis_tinggal", to = "id")]
    pub jenis_tinggal_rel: BelongsTo<Option<crate::models::feeder::referensi::jenis_tinggal::Entity>>,
    #[serde(skip)]
    #[sea_orm(belongs_to, from = "id_alat_transportasi", to = "id")]
    pub alat_transportasi_rel: BelongsTo<Option<crate::models::feeder::referensi::alat_transportasi::Entity>>,
}
