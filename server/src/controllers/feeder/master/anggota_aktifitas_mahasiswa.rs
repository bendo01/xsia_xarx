...
use crate::dtos::feeder::master::anggota_aktifitas_mahasiswa::{
    CreateAnggotaAktifitasMahasiswaRequest, AnggotaAktifitasMahasiswaQuery, AnggotaAktifitasMahasiswaResponse, PaginatedAnggotaAktifitasMahasiswaResponse,
    UpdateAnggotaAktifitasMahasiswaRequest,
};
use crate::dtos::common::reference::MessageResponse;
use crate::models::feeder::master::anggota_aktifitas_mahasiswa as entity_mod;
...
pub async fn list_anggota_aktifitas_mahasiswa(
    ...
    let query: AnggotaAktifitasMahasiswaQuery = req.parse_queries().unwrap_or_default();
    ...
    let data = items.into_iter().map(|item| AnggotaAktifitasMahasiswaResponse {
            id: item.id,
    ...
    Ok(Json(PaginatedAnggotaAktifitasMahasiswaResponse {
        data,
        total,
        page,
        page_size,
...
pub async fn create_anggota_aktifitas_mahasiswa(
    ...
    let active_model = entity_mod::ActiveModel {
        ...
        jenis_peran: Set(payload.jenis_peran),
        nama_jenis_peran: Set(payload.nama_jenis_peran),
