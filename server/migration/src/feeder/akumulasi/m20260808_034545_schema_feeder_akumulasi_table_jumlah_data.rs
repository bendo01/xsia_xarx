...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034545_schema_feeder_akumulasi_table_jumlah_data"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_akumulasi"), Alias::new("jumlah_data")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("total_app").integer().default(0),
                    )
                    .col(
                        ColumnDef::new("total_feeder").integer().default(0),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_akumulasi_jumlah_data_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
