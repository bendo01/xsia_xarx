...
#[endpoint(tags("Academic - Student - Reference - SelectionTyp"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Student - Reference - SelectionTyp"), status_codes(200, 400, 404, 500))]
pub async fn get_selection_type(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("SelectionTyp not found"))?;
...
#[endpoint(tags("Academic - Student - Reference - SelectionTyp"), status_codes(200, 400, 500))]
...
pub async fn delete_selection_type(
    ...
    Ok(Json(MessageResponse {
        message: "SelectionTyp deleted successfully".to_string(),
    }))
}
