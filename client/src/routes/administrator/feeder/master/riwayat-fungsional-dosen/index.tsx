...
export default function FeederMasterIndexPage() {
    const apiPath = "feeder/master/riwayat-fungsional-dosen";
    const basePath = "/feeder/master/riwayat-fungsional-dosen";
                ...
                <div class="sm:flex sm:items-center sm:justify-between border-b border-neutral-200 dark:border-neutral-800 pb-4">
                    <div>
                        <nav class="flex items-center gap-1.5 text-xs text-neutral-500 dark:text-neutral-400 mb-1">
                            ...
                            <span>Master</span>
                            <span>/</span>
                            <span class="font-medium text-neutral-900 dark:text-white">Riwayat Fungsional Dosen</span>
                        </nav>
                        ...
                        <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-0.5">
                            Synchronized master dataset from PDDIKTI Feeder for Riwayat Fungsional Dosen.
                        </p>
                    </div>
                </div>
