...
use crate::models::building::reference::varieties as entity_mod;

#[endpoint(tags("Building - Reference - Variety"), status_codes(200, 500))]
...
#[endpoint(tags("Building - Reference - Variety"), status_codes(200, 400, 404, 500))]
...
}#[endpoint(tags("Building - Reference - Variety"), status_codes(200, 400, 500))]
