...
#[endpoint(tags("Academic - Course - Reference - CurriculumType"), status_codes(200, 400, 404, 500))]
pub async fn get_curriculum_type(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("CurriculumType not found"))?;
...
}#[endpoint(tags("Academic - Course - Reference - CurriculumType"), status_codes(200, 400, 500))]
...
pub async fn delete_curriculum_type(
        ...
        Ok(Json(MessageResponse {
            message: "CurriculumType deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Academic - Course - Reference - CurriculumType"), status_codes(200, 500))]
pub async fn options_curriculum_types(
    req: &mut Request,
    depot: &mut Depot,
