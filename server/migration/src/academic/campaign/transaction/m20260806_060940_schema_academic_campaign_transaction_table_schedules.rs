...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_060940_schema_academic_campaign_transaction_table_schedules"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_campaign_transaction"), Alias::new("schedules")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("start_hour").time().not_null(),
                    )
                    .col(
                        ColumnDef::new("end_hour").time().not_null(),
                    )
                    .col(
                        ColumnDef::new("weekday_id").uuid().not_null().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("room_id").uuid().not_null().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
