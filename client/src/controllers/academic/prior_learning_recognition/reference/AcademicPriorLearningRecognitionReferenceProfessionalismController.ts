...
const path = 'academic/prior-learning-recognition/reference/professionalisms';
...
export async function AcademicPriorLearningRecognitionReferenceControllerProfessionalismIndex(
    ...
    try {
        ...
        console.error('Error in AcademicPriorLearningRecognitionReferenceControllerProfessionalismIndex:', e);
        return {
            pagination: {
                search: props.search || '',
                sort_by: props.sort_by || '',
