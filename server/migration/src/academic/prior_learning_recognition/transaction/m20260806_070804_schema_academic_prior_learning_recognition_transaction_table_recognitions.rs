...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_070804_schema_academic_prior_learning_recognition_transaction_table_recognitions"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_prior_learning_recognition_transaction"), Alias::new("recognitions")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("candidate_id").uuid().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("academic_prior_learning_recognition_transaction_recognitions_pk")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
