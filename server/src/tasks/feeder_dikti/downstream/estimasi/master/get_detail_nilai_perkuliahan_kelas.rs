...
const API_ACTION: &str = "GetDetailNilaiPerkuliahanKelas";
...
impl EstimateDetailNilaiPerkuliahanKelas {
...
#[async_trait]
impl Task for EstimateDetailNilaiPerkuliahanKelas {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetDetailNilaiPerkuliahanKelas data from Feeder Dikti"
    }
