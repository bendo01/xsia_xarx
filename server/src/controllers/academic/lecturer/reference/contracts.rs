...
use crate::models::academic::lecturer::reference::contracts as entity_mod;

#[endpoint(tags("Academic - Lecturer - Reference - Contract"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Lecturer - Reference - Contract"), status_codes(200, 400, 404, 500))]
pub async fn get_contract(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Contract not found"))?;
...
#[endpoint(tags("Academic - Lecturer - Reference - Contract"), status_codes(200, 400, 500))]
