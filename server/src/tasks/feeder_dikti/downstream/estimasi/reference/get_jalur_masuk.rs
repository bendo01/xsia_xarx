...
const TASK_NAME: &str = "EstimateGetJalurMasuk";
const API_ACTION: &str = "GetJalurMasuk";
...
pub struct EstimateGetJalurMasuk;

impl EstimateGetJalurMasuk {
    ...
    async fn upsert_record(txn: &DatabaseTransaction, record: &GetJalurMasukResponse) -> Result<String, Box<dyn std::error::Error + Send + Sync>> {
    ...
    async fn fetch_and_process_page(
        ...
        let response = RequestData::get::<GetJalurMasukResponse>(
            InputRequestData {
...
#[async_trait]
impl Task for EstimateGetJalurMasuk {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetJalurMasuk data from Feeder Dikti"
    }
