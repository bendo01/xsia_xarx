...
export async function PersonReferenceControllerReligionDelete(data: TypeInputEntityReferenceForm): Promise<UpsertDeleteMessage> {
    let returned = {
        is_error: false,
        code: 200,
        message: "success to upsert reference.",
...
export async function PersonReferenceControllerReligionList(): Promise<{
    ...
    try {
        const response = await fetch(`${server_api_url}person/reference/religions/list`, {
            method: "GET",
            headers: {
