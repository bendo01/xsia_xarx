...
use crate::models::contact::reference::electronic_mail_types as entity_mod;

#[endpoint(tags("Contact - Reference - ElectronicMailType"), status_codes(200, 500))]
pub async fn list_electronic_mail_types(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Contact - Reference - ElectronicMailType"), status_codes(200, 400, 404, 500))]
pub async fn get_electronic_mail_type(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("ElectronicMailType not found"))?;
...
}#[endpoint(tags("Contact - Reference - ElectronicMailType"), status_codes(200, 400, 500))]
pub async fn create_electronic_mail_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Contact - Reference - ElectronicMailType"), status_codes(200, 400, 404, 500))]
pub async fn update_electronic_mail_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Contact - Reference - ElectronicMailType"), status_codes(200, 400, 404, 500))]
pub async fn delete_electronic_mail_type(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "ElectronicMailType deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Contact - Reference - ElectronicMailType"), status_codes(200, 500))]
pub async fn options_electronic_mail_types(
    req: &mut Request,
    depot: &mut Depot,
