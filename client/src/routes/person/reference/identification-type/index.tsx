            ...
            >
                <div class="p-6">
                    <div class="flex items-center gap-3 text-red-600 dark:text-red-400 mb-3">
                        ...
                        <h3 class="text-lg font-bold text-neutral-900 dark:text-white">Delete Identification Type</h3>
                    </div>

                    <p class="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
                        Are you sure you want to delete <strong class="text-neutral-900 dark:text-white">{selectedItem()?.name}</strong> (Code: {selectedItem()?.code})? This action cannot be undone.
                    </p>
