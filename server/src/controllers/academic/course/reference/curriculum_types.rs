...
#[endpoint(tags("Academic - Course - Reference - CurriculumTyp"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Course - Reference - CurriculumTyp"), status_codes(200, 400, 404, 500))]
pub async fn get_curriculum_type(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("CurriculumTyp not found"))?;
...
}#[endpoint(tags("Academic - Course - Reference - CurriculumTyp"), status_codes(200, 400, 500))]
pub async fn create_curriculum_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - Course - Reference - CurriculumTyp"), status_codes(200, 400, 404, 500))]
pub async fn update_curriculum_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - Course - Reference - CurriculumTyp"), status_codes(200, 400, 404, 500))]
pub async fn delete_curriculum_type(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "CurriculumTyp deleted successfully".to_string(),
        }))
}
