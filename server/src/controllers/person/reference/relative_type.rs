...
use crate::models::person::reference::relative_type as entity_mod;

#[endpoint(tags("Person - Reference - RelativeType"), status_codes(200, 500))]
pub async fn list_relative_type(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Person - Reference - RelativeType"), status_codes(200, 400, 404, 500))]
pub async fn get_relative_type(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("RelativeType not found"))?;
...
}#[endpoint(tags("Person - Reference - RelativeType"), status_codes(200, 400, 500))]
pub async fn create_relative_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Person - Reference - RelativeType"), status_codes(200, 400, 404, 500))]
pub async fn update_relative_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Person - Reference - RelativeType"), status_codes(200, 400, 404, 500))]
pub async fn delete_relative_type(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "RelativeType deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Person - Reference - RelativeType"), status_codes(200, 500))]
pub async fn options_relative_type(
    req: &mut Request,
    depot: &mut Depot,
