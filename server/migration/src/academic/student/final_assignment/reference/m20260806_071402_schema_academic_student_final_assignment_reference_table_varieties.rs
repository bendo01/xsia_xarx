...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_071402_schema_academic_student_final_assignment_reference_table_varieties"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_student_final_assignment_reference"), Alias::new("varieties")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("academic_student_final_assignment_reference_varieties_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
