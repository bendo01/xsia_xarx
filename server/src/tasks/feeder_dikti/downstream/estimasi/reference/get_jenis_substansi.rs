...
const API_ACTION: &str = "GetJenisSubstansi";
...
impl EstimateGetJenisSubstansi {
    ...
    async fn fetch_and_process_page(
        ...
        let response = RequestData::get::<GetJenisSubstansiResponse>(
            InputRequestData {
...
#[async_trait]
impl Task for EstimateGetJenisSubstansi {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetJenisSubstansi data from Feeder Dikti"
    }
