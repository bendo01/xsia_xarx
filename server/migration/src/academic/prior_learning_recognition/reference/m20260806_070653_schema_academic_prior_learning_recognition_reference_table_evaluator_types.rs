...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_070653_schema_academic_prior_learning_recognition_reference_table_evaluator_types"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_prior_learning_recognition_reference"), Alias::new("evaluator_types")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("academic_prior_learning_recognition_reference_evaluator_types_p")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
