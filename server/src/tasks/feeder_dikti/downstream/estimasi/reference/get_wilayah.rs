...
const API_ACTION: &str = "GetWilayah";
...
impl EstimateGetWilayah {
    ...
    async fn fetch_and_process_page(
        ...
        let response = RequestData::get::<GetWilayahResponse>(
            InputRequestData {
...
#[async_trait]
impl Task for EstimateGetWilayah {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetWilayah data from Feeder Dikti"
    }
