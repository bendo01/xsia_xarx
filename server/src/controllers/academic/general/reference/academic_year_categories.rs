...
#[endpoint(tags("Academic - General - Reference - AcademicYearCategori"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - General - Reference - AcademicYearCategori"), status_codes(200, 400, 404, 500))]
pub async fn get_academic_year_categorie(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("AcademicYearCategori not found"))?;
...
#[endpoint(tags("Academic - General - Reference - AcademicYearCategori"), status_codes(200, 400, 500))]
...
pub async fn delete_academic_year_categorie(
    ...
    Ok(Json(MessageResponse {
        message: "AcademicYearCategori deleted successfully".to_string(),
    }))
}
