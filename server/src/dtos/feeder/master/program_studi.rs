...
pub struct ProgramStudiQuery {
    pub page: Option<u64>,
    pub page_size: Option<u64>,
}

#[derive(Serialize, Deserialize, ToSchema, Debug, Clone)]
pub struct ProgramStudiResponse {
    pub id: Uuid,
...
pub struct CreateProgramStudiRequest {
    pub id_perguruan_tinggi: Option<Uuid>,
    pub kode_perguruan_tinggi: Option<String>,
    pub nama_perguruan_tinggi: Option<String>,
    pub id_prodi: Option<Uuid>,
...
#[derive(Serialize, Deserialize, ToSchema, Debug, Clone, Validate)]
pub struct UpdateProgramStudiRequest {
    pub id_perguruan_tinggi: Option<Uuid>,
    pub kode_perguruan_tinggi: Option<String>,
    pub nama_perguruan_tinggi: Option<String>,
    pub id_prodi: Option<Uuid>,
...
#[derive(Serialize, Deserialize, ToSchema, Debug, Clone)]
pub struct PaginatedProgramStudiResponse {
    pub data: Vec<ProgramStudiResponse>,
    pub total: u64,
    pub page: u64,
    pub page_size: u64,
    pub total_pages: u64,
