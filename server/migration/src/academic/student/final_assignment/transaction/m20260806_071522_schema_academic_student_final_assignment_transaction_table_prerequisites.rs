...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_student_final_assignment_transaction"), Alias::new("prerequisites")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("requirement_id").uuid().not_null(),
                    )
                    .col(
                        ColumnDef::new("submission_id").uuid().not_null(),
                    )
                    .col(
                        ColumnDef::new("approval_type_id").uuid().not_null(),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("academic_student_final_assignment_transaction_prerequisites_pke")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
