...
use crate::jobs::feeder_dikti::downstream::master::upsert::get_list_skala_nilai_prodi::{
    ModelInput, Worker as JobWorker, WorkerArgs,
};

// Configuration constants
const TASK_NAME: &str = "EstimateListSkalaNilaiProdi";
const API_ACTION: &str = "GetListSkalaNilaiProdi";

// API Request Configuration
const DEFAULT_LIMIT: i32 = 1000;
const DEFAULT_ORDER: &str = "nama_program_studi ASC";
const DEFAULT_FILTER: &str = "";


pub struct EstimateListSkalaNilaiProdi;

impl EstimateListSkalaNilaiProdi {
...
#[async_trait]
impl Task for EstimateListSkalaNilaiProdi {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetListSkalaNilaiProdi data from Feeder Dikti"
    }
