...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_064335_schema_academic_course_reference_table_varieties"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_course_reference"), Alias::new("varieties")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("curriculum_type_id").uuid().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
