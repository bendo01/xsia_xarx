...
use crate::models::person::reference::profession as entity_mod;

#[endpoint(tags("Person - Reference - Profession"), status_codes(200, 500))]
pub async fn list_profession(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Person - Reference - Profession"), status_codes(200, 400, 404, 500))]
pub async fn get_profession(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Profession not found"))?;
...
}#[endpoint(tags("Person - Reference - Profession"), status_codes(200, 400, 500))]
...
pub async fn delete_profession(
        ...
        Ok(Json(MessageResponse {
            message: "Profession deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Person - Reference - Profession"), status_codes(200, 500))]
pub async fn options_profession(
    req: &mut Request,
    depot: &mut Depot,
