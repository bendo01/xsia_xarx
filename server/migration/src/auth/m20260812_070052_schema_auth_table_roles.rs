...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260812_070052_schema_auth_table_roles"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("auth"), Alias::new("roles")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id")
                            .uuid()
                    ...
                    .col(
                        ColumnDef::new("roleable_id").uuid().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("roleable_type").string_len(255),
                    )
                    .col(
