...
use crate::models::academic::student::reference::statuses as entity_mod;

#[endpoint(tags("Academic - Student - Reference - Statuse"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Student - Reference - Statuse"), status_codes(200, 400, 404, 500))]
...
}#[endpoint(tags("Academic - Student - Reference - Statuse"), status_codes(200, 400, 500))]
