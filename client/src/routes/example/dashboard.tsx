...
const Chart = clientOnly(async () => {
    const mod = await import('@tanstack/charts/solid');
...
import { pie, polar, radialArc, angleGrid, radialGrid, radialLine, radialBarRadius, radialDot } from '@tanstack/charts/polar';
