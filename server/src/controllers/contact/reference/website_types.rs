...
use crate::models::contact::reference::website_types as entity_mod;

#[endpoint(tags("Contact - Reference - WebsiteType"), status_codes(200, 500))]
pub async fn list_website_types(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Contact - Reference - WebsiteType"), status_codes(200, 400, 404, 500))]
pub async fn get_website_type(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("WebsiteType not found"))?;
...
}#[endpoint(tags("Contact - Reference - WebsiteType"), status_codes(200, 400, 500))]
pub async fn create_website_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Contact - Reference - WebsiteType"), status_codes(200, 400, 404, 500))]
pub async fn update_website_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Contact - Reference - WebsiteType"), status_codes(200, 400, 404, 500))]
pub async fn delete_website_type(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "WebsiteType deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Contact - Reference - WebsiteType"), status_codes(200, 500))]
pub async fn options_website_types(
    req: &mut Request,
    depot: &mut Depot,
