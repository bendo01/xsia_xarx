...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034546_schema_feeder_master_table_program_studi"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_master"), Alias::new("program_studi")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("kode_program_studi").string_len(255),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_master_program_studi_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
