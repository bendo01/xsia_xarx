...
#[endpoint(tags("Academic - Student - Final_Assignment - Reference - AdviserCategori"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Student - Final_Assignment - Reference - AdviserCategori"), status_codes(200, 400, 404, 500))]
pub async fn get_adviser_categorie(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("AdviserCategori not found"))?;
...
#[endpoint(tags("Academic - Student - Final_Assignment - Reference - AdviserCategori"), status_codes(200, 400, 500))]
...
pub async fn delete_adviser_categorie(
    ...
    Ok(Json(MessageResponse {
        message: "AdviserCategori deleted successfully".to_string(),
    }))
}
