...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260805_073625_schema_location_table_regencies"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("location"), Alias::new("regencies")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id")
                            .uuid()
                    ...
                    .col(
                        ColumnDef::new("epsbed_code")
                            .string_len(255),
                    )
                    .col(
                        ColumnDef::new("province_id")
                            .uuid()
                            .not_null()
                            .default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("regency_type_id")
                            .uuid()
                            .not_null()
                            .default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    ...
                    .col(
                        ColumnDef::new("state_ministry_full_code")
                            .string_len(255),
                    )
                    .col(
