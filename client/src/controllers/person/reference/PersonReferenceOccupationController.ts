...
export async function PersonReferenceControllerOccupationDelete(data: TypeInputEntityReferenceForm): Promise<UpsertDeleteMessage> {
    let returned = {
        is_error: false,
        code: 200,
        message: "success to upsert reference.",
...
export async function PersonReferenceControllerOccupationList(): Promise<{
    ...
    try {
        const response = await fetch(`${server_api_url}person/reference/occupations/list`, {
            method: "GET",
            headers: {
