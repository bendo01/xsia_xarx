...
use crate::models::building::reference::categories as entity_mod;

#[endpoint(tags("Building - Reference - Categori"), status_codes(200, 500))]
...
#[endpoint(tags("Building - Reference - Categori"), status_codes(200, 400, 404, 500))]
...
}#[endpoint(tags("Building - Reference - Categori"), status_codes(200, 400, 500))]
