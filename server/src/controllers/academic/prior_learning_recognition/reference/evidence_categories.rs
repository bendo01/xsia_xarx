...
use crate::models::academic::prior_learning_recognition::reference::evidence_categories as entity_mod;

#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvidenceCategori"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvidenceCategori"), status_codes(200, 400, 404, 500))]
pub async fn get_evidence_categorie(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("EvidenceCategori not found"))?;
...
#[endpoint(tags("Academic - Prior_Learning_Recognition - Reference - EvidenceCategori"), status_codes(200, 400, 500))]
...
pub async fn delete_evidence_categorie(
    ...
    Ok(Json(MessageResponse {
        message: "EvidenceCategori deleted successfully".to_string(),
    }))
}
