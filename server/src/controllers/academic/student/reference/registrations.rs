...
use crate::models::academic::student::reference::registrations as entity_mod;

#[endpoint(tags("Academic - Student - Reference - Registration"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Student - Reference - Registration"), status_codes(200, 400, 404, 500))]
pub async fn get_registration(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Registration not found"))?;
...
}#[endpoint(tags("Academic - Student - Reference - Registration"), status_codes(200, 400, 500))]
...
#[endpoint(tags("Academic - Student - Reference - Registration"), status_codes(200, 500))]
pub async fn options_registrations(
    req: &mut Request,
    depot: &mut Depot,
