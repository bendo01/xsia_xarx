...
use crate::jobs::feeder_dikti::downstream::master::upsert::get_list_dosen::{
    ModelInput, Worker as JobWorker, WorkerArgs,
};

// Configuration constants
const TASK_NAME: &str = "EstimateListDosen";
const API_ACTION: &str = "GetListDosen";
...
pub struct EstimateListDosen;

impl EstimateListDosen {
...
#[async_trait]
impl Task for EstimateListDosen {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetListDosen data from Feeder Dikti"
    }
