...
use crate::models::academic::student::final_assignment::reference::requirements as entity_mod;

#[endpoint(tags("Academic - Student - Final_Assignment - Reference - Requirement"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Student - Final_Assignment - Reference - Requirement"), status_codes(200, 400, 404, 500))]
pub async fn get_requirement(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Requirement not found"))?;
...
}#[endpoint(tags("Academic - Student - Final_Assignment - Reference - Requirement"), status_codes(200, 400, 500))]
...
#[endpoint(tags("Academic - Student - Final_Assignment - Reference - Requirement"), status_codes(200, 500))]
pub async fn options_requirements(
    req: &mut Request,
    depot: &mut Depot,
