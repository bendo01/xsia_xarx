...
pub async fn list_marital_statuses(
    req: &mut Request,
    depot: &mut Depot,
...
pub async fn get_marital_status(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .map_err(|e| StatusError::internal_server_error().brief(e.to_string()))?
        .ok_or_else(|| {
            StatusError::not_found().brief(format!("MaritalStatu not found"))
        })?;
...
pub async fn create_marital_status(
    req: &mut Request,
    depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
    let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Person Reference - MaritalStatu"), status_codes(200, 400, 404, 500))]
pub async fn update_marital_status(
    req: &mut Request,
    depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
    let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Person Reference - MaritalStatu"), status_codes(200, 400, 404, 500))]
pub async fn delete_marital_status(
    req: &mut Request,
    depot: &mut Depot,
    ...
    Ok(Json(MessageResponse {
        message: format!("MaritalStatu deleted successfully"),
    }))
}
