...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260803_160025_schema_auth_table_permission_position_type"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("auth"), Alias::new("permission_position_type")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id")
                            .uuid()
                    ...
                    .primary_key(
                        Index::create()
                            .name("auth_permission_position_type_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
