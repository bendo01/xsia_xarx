...
pub struct WorkerArgs {
    pub records: Vec<GetJabatanFungsionalResponse>,
}
...
pub async fn start_worker(
    ...
    let worker = WorkerBuilder::new("xsia-xarx:feeder_dikti:downstream:reference:get_jab_fung")
        .data(db)
        .backend(storage)
        .build_fn(handle_job);
...
impl Worker {
    ...
    pub async fn upsert_record(txn: &DatabaseTransaction, record: &GetJabatanFungsionalResponse) -> Result<String, Box<dyn std::error::Error + Send + Sync>> {
