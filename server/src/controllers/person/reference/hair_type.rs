...
use crate::models::person::reference::hair_type as entity_mod;

#[endpoint(tags("Person - Reference - HairType"), status_codes(200, 500))]
pub async fn list_hair_type(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Person - Reference - HairType"), status_codes(200, 400, 404, 500))]
pub async fn get_hair_type(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("HairType not found"))?;
...
}#[endpoint(tags("Person - Reference - HairType"), status_codes(200, 400, 500))]
pub async fn create_hair_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
pub async fn delete_hair_type(
        ...
        Ok(Json(MessageResponse {
            message: "HairType deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Person - Reference - HairType"), status_codes(200, 500))]
pub async fn options_hair_type(
    req: &mut Request,
    depot: &mut Depot,
