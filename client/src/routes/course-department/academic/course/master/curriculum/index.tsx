...
export default function MasterIndexPage() {
    ...
    const resolveDepartmentUnitId = async (): Promise<string> => {
            ...
            >
                <div class="p-6">
                    <div class="flex items-center gap-3 text-red-600 dark:text-red-400 mb-4">
                        ...
                        <h3 class="text-base font-bold text-neutral-900 dark:text-white">Delete Curriculum Record</h3>
                    </div>
