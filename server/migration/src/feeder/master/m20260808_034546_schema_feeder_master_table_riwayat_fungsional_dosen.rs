...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034546_schema_feeder_master_table_riwayat_fungsional_dosen"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_master"), Alias::new("riwayat_fungsional_dosen")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("id_jabatan_fungsional").uuid(),
                    )
                    .col(
                        ColumnDef::new("nama_jabatan_fungsional").string_len(255),
                    )
                    .col(
                        ColumnDef::new("sk_jabatan_fungsional").string_len(255),
                    )
                    .col(
                        ColumnDef::new("mulai_sk_jabatan").date(),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_master_riwayat_fungsional_dosen_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
