...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_065126_schema_academic_lecturer_transaction_table_academic_ranks"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_lecturer_transaction"), Alias::new("academic_ranks")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("rank_id").uuid().not_null().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
