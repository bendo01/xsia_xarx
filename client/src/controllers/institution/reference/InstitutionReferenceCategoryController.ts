...
const path = "institution/reference/category";
...
export async function InstitutionReferenceControllerCategoryDelete(data: TypeInputEntityReferenceForm): Promise<UpsertDeleteMessage> {
    let returned = {
        is_error: false,
        code: 200,
        message: "success to upsert reference.",
