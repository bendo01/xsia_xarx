...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_061038_schema_academic_campaign_transaction_table_teach_evaluations"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_campaign_transaction"), Alias::new("teach_evaluations")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("evaluation_weight").float().default(Expr::cust("'0'::real")),
                    )
                    .col(
                        ColumnDef::new("evaluation_type_id").uuid().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("act_teach_evaluations_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
