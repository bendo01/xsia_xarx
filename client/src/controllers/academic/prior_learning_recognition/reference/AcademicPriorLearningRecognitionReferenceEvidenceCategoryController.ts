...
const path = 'academic/prior-learning-recognition/reference/evidence-categories';
...
export async function AcademicPriorLearningRecognitionReferenceControllerEvidenceCategoryIndex(
    ...
    try {
        ...
        console.error('Error in AcademicPriorLearningRecognitionReferenceControllerEvidenceCategoryIndex:', e);
        return {
            pagination: {
                search: props.search || '',
                sort_by: props.sort_by || '',
