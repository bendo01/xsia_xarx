...
pub async fn start_worker(
    ...
    let worker = WorkerBuilder::new("xsia-xarx:feeder_dikti:synchronize:downstream:master:upsert_nilai_transfer_pendidikan_mahasiswa_to_academic_student_campaign_convertions")
        .data(db)
        .backend(storage)
        .build_fn(handle_job);
