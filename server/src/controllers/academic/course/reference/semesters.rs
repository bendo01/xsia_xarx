...
use crate::models::academic::course::reference::semesters as entity_mod;

#[endpoint(tags("Academic - Course - Reference - Semester"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Course - Reference - Semester"), status_codes(200, 400, 404, 500))]
...
}#[endpoint(tags("Academic - Course - Reference - Semester"), status_codes(200, 400, 500))]
...
#[endpoint(tags("Academic - Course - Reference - Semester"), status_codes(200, 500))]
pub async fn options_semesters(
    req: &mut Request,
    depot: &mut Depot,
