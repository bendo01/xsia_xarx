...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034547_schema_feeder_rekapitulasi_table_kartu_hasil_studi_mahasiswa"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_rekapitulasi"), Alias::new("kartu_hasil_studi_mahasiswa")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("nilai_angka").integer(),
                    )
                    .col(
                        ColumnDef::new("nilai_huruf").string_len(255),
                    )
                    .col(
                        ColumnDef::new("nilai_indeks").integer(),
                    )
                    .col(
                        ColumnDef::new("sks_x_indeks").integer(),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_rekapitulasi_kartu_hasil_studi_mahasiswa_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
