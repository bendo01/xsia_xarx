...
use crate::models::academic::student::final_assignment::reference::stages as entity_mod;

#[endpoint(tags("Academic - Student - Final_Assignment - Reference - Stag"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Student - Final_Assignment - Reference - Stag"), status_codes(200, 400, 404, 500))]
pub async fn get_stage(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Stag not found"))?;
...
}#[endpoint(tags("Academic - Student - Final_Assignment - Reference - Stag"), status_codes(200, 400, 500))]
...
pub async fn delete_stage(
        ...
        Ok(Json(MessageResponse {
            message: "Stag deleted successfully".to_string(),
        }))
}
