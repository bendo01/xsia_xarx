...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_150351_schema_contact_reference_table_electronic_mail_types"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .get_connection()
            .execute_unprepared("CREATE SCHEMA IF NOT EXISTS contact_reference")
            .await?;

        manager
            .create_table(
                Table::create()
                    .table((Alias::new("contact_reference"), Alias::new("electronic_mail_types")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("cr_electronic_mail_types_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
