...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_referensi"), Alias::new("pangkat_golongan")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("kode_golongan").string_len(255),
                    )
                    .col(
                        ColumnDef::new("nama_pangkat").string_len(255),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_referensi_pangkat_golongan_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
