...
use crate::models::academic::student::final_assignment::reference::adviser_categories as entity_mod;

#[endpoint(tags("Academic - Student - Final_Assignment - Reference - AdviserCategory"), status_codes(200, 500))]
pub async fn list_adviser_categories(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Academic - Student - Final_Assignment - Reference - AdviserCategory"), status_codes(200, 400, 404, 500))]
pub async fn get_adviser_categorie(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("AdviserCategory not found"))?;
...
}#[endpoint(tags("Academic - Student - Final_Assignment - Reference - AdviserCategory"), status_codes(200, 400, 500))]
pub async fn create_adviser_categorie(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - Student - Final_Assignment - Reference - AdviserCategory"), status_codes(200, 400, 404, 500))]
pub async fn update_adviser_categorie(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - Student - Final_Assignment - Reference - AdviserCategory"), status_codes(200, 400, 404, 500))]
pub async fn delete_adviser_categorie(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "AdviserCategory deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Academic - Student - Final_Assignment - Reference - AdviserCategory"), status_codes(200, 500))]
pub async fn options_adviser_categories(
    req: &mut Request,
    depot: &mut Depot,
