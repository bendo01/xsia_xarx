...
#[derive(Serialize, Deserialize, ToSchema, Debug, Clone)]
pub struct PaginatedCoursResponse {
    pub data: Vec<CoursResponse>,
    pub total: u64,
    pub page: u64,
    pub page_size: u64,
    pub total_pages: u64,
