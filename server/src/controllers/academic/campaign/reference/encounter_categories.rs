...
#[endpoint(tags("Academic - Campaign - Reference - EncounterCategori"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Campaign - Reference - EncounterCategori"), status_codes(200, 400, 404, 500))]
pub async fn get_encounter_categorie(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("EncounterCategori not found"))?;
...
#[endpoint(tags("Academic - Campaign - Reference - EncounterCategori"), status_codes(200, 400, 500))]
...
pub async fn delete_encounter_categorie(
    ...
    Ok(Json(MessageResponse {
        message: "EncounterCategori deleted successfully".to_string(),
    }))
}
