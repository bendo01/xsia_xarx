...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_060919_schema_academic_campaign_transaction_table_calendars"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_campaign_transaction"), Alias::new("calendars")))
                    .if_not_exists()
                    .col(
