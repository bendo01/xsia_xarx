...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_064126_schema_academic_course_reference_table_curriculum_types"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_course_reference"), Alias::new("curriculum_types")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("acr_curriculum_types_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
