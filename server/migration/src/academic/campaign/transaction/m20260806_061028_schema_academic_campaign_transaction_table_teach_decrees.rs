...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_061028_schema_academic_campaign_transaction_table_teach_decrees"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_campaign_transaction"), Alias::new("teach_decrees")))
                    .if_not_exists()
                    .col(
