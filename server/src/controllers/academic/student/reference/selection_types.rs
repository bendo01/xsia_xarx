...
use crate::models::academic::student::reference::selection_types as entity_mod;

#[endpoint(tags("Academic - Student - Reference - SelectionType"), status_codes(200, 500))]
pub async fn list_selection_types(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Academic - Student - Reference - SelectionType"), status_codes(200, 400, 404, 500))]
pub async fn get_selection_type(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("SelectionType not found"))?;
...
}#[endpoint(tags("Academic - Student - Reference - SelectionType"), status_codes(200, 400, 500))]
pub async fn create_selection_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - Student - Reference - SelectionType"), status_codes(200, 400, 404, 500))]
pub async fn update_selection_type(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
#[endpoint(tags("Academic - Student - Reference - SelectionType"), status_codes(200, 400, 404, 500))]
pub async fn delete_selection_type(
        req: &mut Request,
        depot: &mut Depot,
        ...
        Ok(Json(MessageResponse {
            message: "SelectionType deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Academic - Student - Reference - SelectionType"), status_codes(200, 500))]
pub async fn options_selection_types(
    req: &mut Request,
    depot: &mut Depot,
