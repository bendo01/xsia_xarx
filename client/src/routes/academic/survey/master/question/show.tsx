...
export default function MasterShowPage() {
    const apiPath = "academic/survey/master/questions";
    const basePath = "/academic/survey/master/question";
                ...
                <div class="sm:flex sm:items-center sm:justify-between border-b border-neutral-200 dark:border-neutral-800 pb-4">
                    <div>
                        <nav class="flex items-center gap-1.5 text-xs text-neutral-500 dark:text-neutral-400 mb-1">
                            ...
                            <span>Master</span>
                            <span>/</span>
                            <a href={basePath} class="hover:text-blue-600 transition-colors">Survey Question</a>
                            <span>/</span>
                    ...
                    <div class="mt-4 sm:mt-0 flex items-center gap-2">
                        ...
                        <Show when={selectedId()}>
                            ...
                            >
                                ...
                                <span>Edit Survey Question</span>
                            </a>
                        </Show>
                    </div>
                </div>
