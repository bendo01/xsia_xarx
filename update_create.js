...
let content = fs.readFileSync('client/src/routes/course-department/academic/course/master/curriculum/create.tsx', 'utf8');

// Add imports
content = content.replace("import { createSignal } from 'solid-js';", 
`import { createSignal, onMount, For } from 'solid-js';
import { getBaseApiUrl, getAuthHeaders, masterApiShow } from '~/controllers/master/masterApiController';
...
fs.writeFileSync('client/src/routes/course-department/academic/course/master/curriculum/create.tsx', content);
