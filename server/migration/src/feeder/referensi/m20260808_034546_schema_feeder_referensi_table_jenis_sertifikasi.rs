...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034546_schema_feeder_referensi_table_jenis_sertifikasi"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_referensi"), Alias::new("jenis_sertifikasi")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("feeder_referensi_jenis_sertifikasi_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
