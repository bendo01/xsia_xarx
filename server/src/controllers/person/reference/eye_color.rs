...
use crate::models::person::reference::eye_color as entity_mod;

#[endpoint(tags("Person - Reference - EyeColor"), status_codes(200, 500))]
pub async fn list_eye_color(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Person - Reference - EyeColor"), status_codes(200, 400, 404, 500))]
pub async fn get_eye_color(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("EyeColor not found"))?;
...
}#[endpoint(tags("Person - Reference - EyeColor"), status_codes(200, 400, 500))]
pub async fn create_eye_color(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
pub async fn delete_eye_color(
        ...
        Ok(Json(MessageResponse {
            message: "EyeColor deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Person - Reference - EyeColor"), status_codes(200, 500))]
pub async fn options_eye_color(
    req: &mut Request,
    depot: &mut Depot,
