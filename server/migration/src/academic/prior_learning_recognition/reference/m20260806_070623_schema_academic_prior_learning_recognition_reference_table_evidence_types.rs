...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_070623_schema_academic_prior_learning_recognition_reference_table_evidence_types"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_prior_learning_recognition_reference"), Alias::new("evidence_types")))
                    .if_not_exists()
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("academic_prior_learning_recognition_reference_evidence_types_pk")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
