    ...
    const cleanRedundantCourseIdParam = (resolvedCourseId: string) => {
        if (typeof window !== 'undefined') {
            ...
            if ((params.id === '[id]' || params.id === ':id' || !params.id) && resolvedCourseId) {
                url.pathname = `${courseMasterBasePath}/${resolvedCourseId}/course-evaluation-planning`;
                changed = true;
            }
                ...
                <div class="sm:flex sm:items-center sm:justify-between border-b border-neutral-200 dark:border-neutral-800 pb-4">
                    ...
                    <div class="mt-4 sm:mt-0 flex items-center gap-2">
                        ...
                        >
                            ...
                            <span>Add New Course Evaluation Planning</span>
                        </a>
                    </div>
                </div>
            ...
            >
                <div class="p-6">
                    <div class="flex items-center gap-3 text-red-600 dark:text-red-400 mb-4">
                        ...
                        <h3 class="text-base font-bold text-neutral-900 dark:text-white">Delete Course Evaluation Planning Record</h3>
                    </div>
