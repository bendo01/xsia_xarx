...
#[endpoint(tags("Institution - Reference - UnitType"), status_codes(200, 500))]
...
#[endpoint(tags("Institution - Reference - UnitType"), status_codes(200, 400, 404, 500))]
pub async fn get_unit_type(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("UnitType not found"))?;
...
}#[endpoint(tags("Institution - Reference - UnitType"), status_codes(200, 400, 500))]
...
pub async fn delete_unit_type(
        ...
        Ok(Json(MessageResponse {
            message: "UnitType deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Institution - Reference - UnitType"), status_codes(200, 500))]
pub async fn options_unit_types(
    req: &mut Request,
    depot: &mut Depot,
