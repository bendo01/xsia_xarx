...
#[endpoint(tags("Contact - Reference - ElectronicMailTyp"), status_codes(200, 500))]
...
#[endpoint(tags("Contact - Reference - ElectronicMailTyp"), status_codes(200, 400, 404, 500))]
pub async fn get_electronic_mail_type(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("ElectronicMailTyp not found"))?;
...
#[endpoint(tags("Contact - Reference - ElectronicMailTyp"), status_codes(200, 400, 500))]
...
pub async fn delete_electronic_mail_type(
    ...
    Ok(Json(MessageResponse {
        message: "ElectronicMailTyp deleted successfully".to_string(),
    }))
}
