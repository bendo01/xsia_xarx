...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260808_034546_schema_feeder_master_table_penugasan_dosen"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("feeder_master"), Alias::new("penugasan_dosen")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("id_tahun_ajaran").string_len(255),
                    )
                    .col(
                        ColumnDef::new("nama_tahun_ajaran").string_len(255),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new("nomor_surat_tugas").string_len(255),
                    )
                    .col(
                        ColumnDef::new("tanggal_surat_tugas").string_len(255),
                    )
                    .col(
                        ColumnDef::new("mulai_surat_tugas").string_len(255),
                    )
                    .col(
                        ColumnDef::new("tgl_create").string_len(255),
                    )
                    .col(
                        ColumnDef::new("tgl_ptk_keluar").string_len(255),
                    )
                    .col(
                        ColumnDef::new("id_stat_pegawai").integer(),
                    )
                    .col(
                        ColumnDef::new("id_jns_keluar").integer(),
                    )
                    .col(
                        ColumnDef::new("id_ikatan_kerja").string_len(255),
                    )
                    .col(
                        ColumnDef::new("apakah_homebase").boolean(),
                    )
                    .primary_key(
                        Index::create()
                            .name("feeder_master_penugasan_dosen_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
