...
use crate::models::academic::lecturer::reference::statuses as entity_mod;

#[endpoint(tags("Academic - Lecturer - Reference - Statuse"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Lecturer - Reference - Statuse"), status_codes(200, 400, 404, 500))]
pub async fn get_statuse(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Statuse not found"))?;
...
}#[endpoint(tags("Academic - Lecturer - Reference - Statuse"), status_codes(200, 400, 500))]
pub async fn create_statuse(
        req: &mut Request,
        depot: &mut Depot,
) -> Result<Json<ReferenceResponse>, StatusError> {
        let db = depot.get_typed::<DatabaseConnection>().map_err(|_| {
...
pub async fn delete_statuse(
        ...
        Ok(Json(MessageResponse {
            message: "Statuse deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Academic - Lecturer - Reference - Statuse"), status_codes(200, 500))]
pub async fn options_statuses(
    req: &mut Request,
    depot: &mut Depot,
