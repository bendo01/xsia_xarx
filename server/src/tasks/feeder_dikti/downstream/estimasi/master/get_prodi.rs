...
impl EstimateGetProdi {
    ...
    async fn fetch_and_process_page(
        ...
        let response = RequestData::get::<GetProdiResponse>(
            InputRequestData {
...
#[async_trait]
impl Task for EstimateGetProdi {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetProdi data from Feeder Dikti"
    }
