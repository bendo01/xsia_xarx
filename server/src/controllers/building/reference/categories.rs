...
#[endpoint(tags("Building - Reference - Category"), status_codes(200, 500))]
...
#[endpoint(tags("Building - Reference - Category"), status_codes(200, 400, 404, 500))]
...
}#[endpoint(tags("Building - Reference - Category"), status_codes(200, 400, 500))]
