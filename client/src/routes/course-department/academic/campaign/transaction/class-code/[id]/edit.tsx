...
import { masterApiUpdate, masterApiShow } from '~/controllers/master/masterApiController';
...
export default function ClassCodeEditPage() {
        ...
        try {
            ...
            if (res.data) {
                ...
                setFormData({
                    ...
                    start_effective_date: item.start_effective_date ? String(item.start_effective_date).split('T')[0] : '',
                    end_effective_date: item.end_effective_date ? String(item.end_effective_date).split('T')[0] : '',
    ...
    const handleSubmit = async (e: Event) => {
        ...
        try {
            ...
            const res = await masterApiUpdate(apiPath, params.id as string, payload);
            if (res.success) {
