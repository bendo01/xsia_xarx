...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260805_071138_schema_institution_reference_table_position_types"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("institution_reference"), Alias::new("position_types")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id")
                            .uuid()
