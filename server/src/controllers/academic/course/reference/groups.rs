...
use crate::models::academic::course::reference::groups as entity_mod;

#[endpoint(tags("Academic - Course - Reference - Group"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Course - Reference - Group"), status_codes(200, 400, 404, 500))]
...
}#[endpoint(tags("Academic - Course - Reference - Group"), status_codes(200, 400, 500))]
