...
use crate::models::academic::campaign::reference::implementations as entity_mod;

#[endpoint(tags("Academic - Campaign - Reference - Implementation"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Campaign - Reference - Implementation"), status_codes(200, 400, 404, 500))]
pub async fn get_implementation(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Implementation not found"))?;
...
}#[endpoint(tags("Academic - Campaign - Reference - Implementation"), status_codes(200, 400, 500))]
...
pub async fn delete_implementation(
        ...
        Ok(Json(MessageResponse {
            message: "Implementation deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Academic - Campaign - Reference - Implementation"), status_codes(200, 500))]
pub async fn options_implementations(
    req: &mut Request,
    depot: &mut Depot,
