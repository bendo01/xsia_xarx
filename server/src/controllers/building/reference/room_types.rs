...
use crate::models::building::reference::room_types as entity_mod;

#[endpoint(tags("Building - Reference - RoomType"), status_codes(200, 500))]
...
#[endpoint(tags("Building - Reference - RoomType"), status_codes(200, 400, 404, 500))]
pub async fn get_room_type(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("RoomType not found"))?;
...
}#[endpoint(tags("Building - Reference - RoomType"), status_codes(200, 400, 500))]
...
pub async fn delete_room_type(
        ...
        Ok(Json(MessageResponse {
            message: "RoomType deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Building - Reference - RoomType"), status_codes(200, 500))]
pub async fn options_room_types(
    req: &mut Request,
    depot: &mut Depot,
