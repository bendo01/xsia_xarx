...
use crate::models::person::reference::occupation as entity_mod;

#[endpoint(tags("Person - Reference - Occupation"), status_codes(200, 500))]
pub async fn list_occupation(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Person - Reference - Occupation"), status_codes(200, 400, 404, 500))]
pub async fn get_occupation(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Occupation not found"))?;
...
}#[endpoint(tags("Person - Reference - Occupation"), status_codes(200, 400, 500))]
...
pub async fn delete_occupation(
        ...
        Ok(Json(MessageResponse {
            message: "Occupation deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Person - Reference - Occupation"), status_codes(200, 500))]
pub async fn options_occupation(
    req: &mut Request,
    depot: &mut Depot,
