...
use crate::jobs::feeder_dikti::downstream::master::upsert::get_detail_kelas_kuliah::{
    ModelInputDetailKelasKuliah, Worker as JobWorker, WorkerArgs,
};

// Configuration constants
const TASK_NAME: &str = "EstimateDetailKelasKuliah";
const API_ACTION: &str = "GetDetailKelasKuliah";

// API Request Configuration
const DEFAULT_LIMIT: i32 = 1000;
const DEFAULT_ORDER: &str = "id_kelas_kuliah ASC";
const DEFAULT_FILTER: &str = "";



pub struct EstimateDetailKelasKuliah;

impl EstimateDetailKelasKuliah {
    ...
    async fn fetch_and_process_page(
        ...
        let response = RequestData::get::<ModelInputDetailKelasKuliah>(
            InputRequestData {
...
#[async_trait]
impl Task for EstimateDetailKelasKuliah {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetDetailKelasKuliah data from Feeder Dikti"
    }
