...
#[endpoint(tags("Academic - Lecturer - Reference - Status"), status_codes(200, 500))]
...
#[endpoint(tags("Academic - Lecturer - Reference - Status"), status_codes(200, 400, 404, 500))]
pub async fn get_statuse(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Status not found"))?;
...
}#[endpoint(tags("Academic - Lecturer - Reference - Status"), status_codes(200, 400, 500))]
