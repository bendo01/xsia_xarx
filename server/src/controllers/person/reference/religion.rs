...
use crate::models::person::reference::religion as entity_mod;

#[endpoint(tags("Person - Reference - Religion"), status_codes(200, 500))]
pub async fn list_religion(
    req: &mut Request,
    depot: &mut Depot,
...
#[endpoint(tags("Person - Reference - Religion"), status_codes(200, 400, 404, 500))]
pub async fn get_religion(
    req: &mut Request,
    depot: &mut Depot,
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("Religion not found"))?;
...
}#[endpoint(tags("Person - Reference - Religion"), status_codes(200, 400, 500))]
...
pub async fn delete_religion(
        ...
        Ok(Json(MessageResponse {
            message: "Religion deleted successfully".to_string(),
        }))
}

#[endpoint(tags("Person - Reference - Religion"), status_codes(200, 500))]
pub async fn options_religion(
    req: &mut Request,
    depot: &mut Depot,
