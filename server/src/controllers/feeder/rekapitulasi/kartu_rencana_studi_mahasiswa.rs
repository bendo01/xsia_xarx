...
use crate::dtos::feeder::rekapitulasi::kartu_rencana_studi_mahasiswa::{
    CreateKartuRencanaStudiMahasiswaRequest, KartuRencanaStudiMahasiswaQuery, KartuRencanaStudiMahasiswaResponse, PaginatedKartuRencanaStudiMahasiswaResponse,
    UpdateKartuRencanaStudiMahasiswaRequest,
};
use crate::dtos::common::reference::MessageResponse;
use crate::models::feeder::rekapitulasi::kartu_rencana_studi_mahasiswa as entity_mod;
...
pub async fn list_kartu_rencana_studi_mahasiswa(
    ...
    let query: KartuRencanaStudiMahasiswaQuery = req.parse_queries().unwrap_or_default();
    ...
    let data = items.into_iter().map(|item| KartuRencanaStudiMahasiswaResponse {
            id: item.id,
    ...
    Ok(Json(PaginatedKartuRencanaStudiMahasiswaResponse {
        data,
        total,
        page,
        page_size,
...
pub async fn get_kartu_rencana_studi_mahasiswa(
    ...
    let item = entity_mod::Entity::find_by_id(id)
        ...
        .ok_or_else(|| StatusError::not_found().brief("KartuRencanaStudiMahasiswa not found"))?;

    Ok(Json(KartuRencanaStudiMahasiswaResponse {
            id: item.id,
            id_registrasi_mahasiswa: item.id_registrasi_mahasiswa,
            nim: item.nim,
            nama_mahasiswa: item.nama_mahasiswa,
...
pub async fn create_kartu_rencana_studi_mahasiswa(
    ...
    let payload: CreateKartuRencanaStudiMahasiswaRequest = req.parse_json().await.map_err(|e| {
...
pub async fn update_kartu_rencana_studi_mahasiswa(
    ...
    let payload: UpdateKartuRencanaStudiMahasiswaRequest = req.parse_json().await.map_err(|e| {
        StatusError::bad_request().brief(format!("Invalid JSON payload: {}", e))
    })?;
...
pub async fn delete_kartu_rencana_studi_mahasiswa(
    ...
    Ok(Json(MessageResponse {
        message: "KartuRencanaStudiMahasiswa deleted successfully".to_string(),
    }))
}
