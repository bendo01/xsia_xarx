...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        db.execute_unprepared(
            "
            CREATE TABLE IF NOT EXISTS academic_student_final_assignment_transaction.final_assignment_decrees
            (
                ...
                CONSTRAINT academic_student_final_assignment_transaction_final_assignment_decrees_pkey PRIMARY KEY (id)
            )
            ",
        )
        .await?;
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .get_connection()
            .execute_unprepared("DROP TABLE IF EXISTS academic_student_final_assignment_transaction.final_assignment_decrees")
            .await?;
