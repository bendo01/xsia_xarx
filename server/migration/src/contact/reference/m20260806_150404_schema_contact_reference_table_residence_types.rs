...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_150404_schema_contact_reference_table_residence_types"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("contact_reference"), Alias::new("residence_types")))
                    .if_not_exists()
                    .col(
