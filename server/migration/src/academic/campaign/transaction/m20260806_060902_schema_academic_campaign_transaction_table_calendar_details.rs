...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260806_060902_schema_academic_campaign_transaction_table_calendar_details"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("academic_campaign_transaction"), Alias::new("calendar_details")))
                    .if_not_exists()
                    .col(
                    ...
                    .col(
                        ColumnDef::new("calendar_category_id").uuid().not_null().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("calendar_id").uuid().not_null().default(Expr::cust("'00000000-0000-0000-0000-000000000000'::uuid")),
                    )
                    .col(
                        ColumnDef::new("start_date").date().not_null(),
                    )
                    .col(
                        ColumnDef::new("end_date").date().not_null(),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("act_calendar_details_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
