...
use crate::jobs::feeder_dikti::downstream::master::upsert::get_peserta_kelas_kuliah::{
    ModelInput, Worker as JobWorker, WorkerArgs,
};

// Configuration constants
const TASK_NAME: &str = "EstimatePesertaKelasKuliah";
const API_ACTION: &str = "GetPesertaKelasKuliah";

// API Request Configuration
const DEFAULT_LIMIT: i32 = 1000;
const DEFAULT_ORDER: &str = "nama_mahasiswa ASC";
const DEFAULT_FILTER: &str = "";


pub struct EstimatePesertaKelasKuliah;

impl EstimatePesertaKelasKuliah {
...
#[async_trait]
impl Task for EstimatePesertaKelasKuliah {
    fn name(&self) -> &str {
        TASK_NAME
    }

    fn description(&self) -> &str {
        "Fetch and process GetPesertaKelasKuliah data from Feeder Dikti"
    }
