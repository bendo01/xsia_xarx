...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20260805_073647_schema_location_table_sub_districts"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table((Alias::new("location"), Alias::new("sub_districts")))
                    .if_not_exists()
                    .col(
                        ColumnDef::new("id")
                            .uuid()
                    ...
                    .col(
                        ColumnDef::new("agriculture_department_name")
                            .string_len(255),
                    )
                    .col(
                    ...
                    .primary_key(
                        Index::create()
                            .name("location_sub_districts_pkey")
                            .col(Alias::new("id")),
                    )
                    .to_owned(),
            )
