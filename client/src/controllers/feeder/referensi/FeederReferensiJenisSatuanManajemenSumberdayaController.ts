...
const path = 'feeder/referensi/jenis-satuan-manajemen-sumberdaya';
...
export async function FeederReferensiControllerJenisSatuanManajemenSumberdayaIndex(
    props: TypePaginationForm,
): Promise<TypePaginationResponse<FeederReferensiJenisSatuanManajemenSumberdaya>> {
    try {
        ...
        console.error('Error in FeederReferensiControllerJenisSatuanManajemenSumberdayaIndex:', e);
        return {
            pagination: {
                search: props.search || '',
                sort_by: props.sort_by || '',
...
export async function FeederReferensiControllerJenisSatuanManajemenSumberdayaUpsert(
    form: {
        id?: string | null;
        id_jenis_satuan_manajemen_sumberdaya?: number | null;
        nama_jenis_satuan_manajemen_sumberdaya?: string | null;
    },
): Promise<{ is_error: boolean; message: string; data?: FeederReferensiJenisSatuanManajemenSumberdaya }> {
    try {
        ...
        const payload: Record<string, any> = {
            id_jenis_satuan_manajemen_sumberdaya: Number(form.id_jenis_satuan_manajemen_sumberdaya),
            nama_jenis_satuan_manajemen_sumberdaya: form.nama_jenis_satuan_manajemen_sumberdaya,
        };
...
export async function FeederReferensiControllerJenisSatuanManajemenSumberdayaDelete(
    props: { id: string },
...
export async function FeederReferensiControllerJenisSatuanManajemenSumberdayaList(): Promise<{
    code: number;
    ...
    try {
        ...
        const items: ModelSelectItem[] = list.map((item: any) => ({
            id: item.id,
            value: item.id,
            label: item.nama_jenis_satuan_manajemen_sumberdaya || String(item.id),
        }));
        return {
            code: 200,
            message: items,
